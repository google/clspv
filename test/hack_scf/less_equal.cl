...
// CHECK:     %[[__original_id_59:[0-9]+]] = OpISub %[[uint]] %[[__original_id_58]] %[[__original_id_56]]
...
// CHECK:     %[[__original_id_63:[0-9]+]] = OpSelect %[[float]] %[[__original_id_62]] %[[float_n1]] %[[float_1]]
...
kernel void lessequal(__global float *outDest, int inWidth, int offset) {
