...
// CHECK-DAG: %[[float_99:[0-9a-zA-Z_]+]] = OpConstant %[[float]] 99
...
// CHECK:     %[[__original_id_79:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_4294967293]]
...
// CHECK:     %[[__original_id_94:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_2]]
...
// CHECK:     %[[__original_id_112:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_4294967295]]
...
// CHECK:     %[[__original_id_123:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_0]]
...
// CHECK:     %[[__original_id_137:[0-9]+]] = OpPhi %[[float]] %[[float_99]] %[[__original_id_148]] %[[__original_id_133]] %[[__original_id_132]]
...
// CHECK:     %[[__original_id_143:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_4294967292]]
...
// CHECK:     %[[__original_id_162:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_1]]
...
// CHECK:     %[[__original_id_173:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_4294967294]]
...
// CHECK:     %[[__original_id_192:[0-9]+]] = OpISub %[[uint]] %[[__original_id_55]] %[[uint_3]]
