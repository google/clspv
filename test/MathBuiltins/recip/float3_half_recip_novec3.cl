...
// CHECK-DAG: %[[FLOAT_VECTOR_UNDEF:[a-zA-Z0-9_]*]] = OpUndef %[[FLOAT_VECTOR_TYPE_ID]]
...
// CHECK: %[[OP_ID4:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[FLOAT_VECTOR_TYPE_ID]] %[[OP_ID]] %[[FLOAT_VECTOR_UNDEF]] 0 1 2 4294967295
