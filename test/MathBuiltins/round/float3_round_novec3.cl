...
// CHECK: [[ld3:%[a-zA-Z0-9_]*]] = OpVectorShuffle [[float4]] [[ld]] [[undef4]] 0 1 2 4294967295
// CHECK: [[fabs:%[a-zA-Z0-9_]+]] = OpExtInst [[float4]] [[ext_inst]] FAbs [[ld3]]
// CHECK: [[fabs4:%[a-zA-Z0-9_]+]] = OpVectorShuffle [[float3]] [[fabs]] [[undef4]] 0 1 2
// CHECK: [[ceil:%[a-zA-Z0-9_]+]] = OpExtInst [[float3]] [[ext_inst]] Ceil [[fabs4]]
// CHECK: [[ceil4:%[a-zA-Z0-9_]+]] = OpVectorShuffle [[float4]] [[ceil]] [[undef3]] 0 1 2 4294967295
// CHECK: [[floor:%[a-zA-Z0-9_]+]] = OpExtInst [[float3]] [[ext_inst]] Floor [[fabs4]]
...
// CHECK: [[sel3a:%[a-zA-Z0-9_]+]] = OpVectorShuffle [[float3]] [[ld]] [[undef4]] 0 1 2
// CHECK: [[cast:%[a-zA-Z0-9_]+]] = OpBitcast [[int3]] [[sel3a]]
