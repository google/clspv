// RUN: clspv %target %s -o %t.spv --use-native-builtins=half_exp10
...
// CHECK-DAG: %[[COMPOSITE_CONSTANT_LN10_ID:[a-zA-Z0-9_]*]] = OpConstantComposite %[[FLOAT_VECTOR_TYPE_ID]] %[[CONSTANT_LN10_ID]] %[[CONSTANT_LN10_ID]] %[[CONSTANT_LN10_ID]] %[[CONSTANT_LN10_ID]]
