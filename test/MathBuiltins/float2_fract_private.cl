...
void kernel foo(global float2* A, global float2* B, float2 x)
{
  float2 z;
  *A = fract(x, &z);
  *B = z;
...
// CHECK: [[_float_1:%[a-zA-Z0-9_]+]] = OpConstant [[_float]] {{1|0.99999}}
// CHECK: [[_17:%[a-zA-Z0-9_]+]] = OpConstantComposite [[_v2float]] [[_float_1]] [[_float_1]]
...
// CHECK: [[_28:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_23]] [[_uint_0]] [[_uint_0]]
// CHECK: [[_29:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_24]] [[_uint_0]] [[_uint_0]]
// CHECK: [[_30:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_25]] [[_uint_0]]
// CHECK: [[_31:%[a-zA-Z0-9_]+]] = OpLoad [[_v2float]] [[_30]]
