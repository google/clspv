...
entry:
  ...
  ;CHECK: %1 = and <2 x i64> splat (i64 9218868437227405312), %0
  ;CHECK: %2 = icmp eq <2 x i64> %1, splat (i64 9218868437227405312)
  ;CHECK: %3 = select <2 x i1> %2, <2 x i32> zeroinitializer, <2 x i32> splat (i32 -1)
