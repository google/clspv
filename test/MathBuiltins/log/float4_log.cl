...
// CHECK: %[[OP_01_MUL:[a-zA-Z0-9_]*]] = OpFMul %{{.*}} %[[OP_01]]
...
// CHECK: %[[OP_23_MUL:[a-zA-Z0-9_]*]] = OpFMul %{{.*}} %[[OP_23]]
// CHECK: %[[OP_FINAL:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[FLOAT_VECTOR_TYPE_ID]] %[[OP_01_MUL]] %[[OP_23_MUL]] 0 1 2 3
