...
void kernel foo(global float4* A, float4 y, float4 x)
{
  *A = atan2pi(y, x);
}
// CHECK: ; SPIR-V
...
// CHECK: [[_29:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v4float]] [[_24]] [[_uint_0]]
// CHECK: [[_30:%[a-zA-Z0-9_]+]] = OpLoad [[_v4float]] [[_29]]
// CHECK: [[_31:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v4float]] [[_25]] [[_uint_0]]
