...
// CHECK: [[_v3float:%[a-zA-Z0-9_]+]] = OpTypeVector [[_float:%[a-zA-Z0-9_]+]] 3
// CHECK: [[__ptr_StorageBuffer_v3float:%[a-zA-Z0-9_]+]] = OpTypePointer StorageBuffer [[_v3float:%[a-zA-Z0-9_]+]]
// CHECK: [[__runtimearr_v3float:%[a-zA-Z0-9_]+]] = OpTypeRuntimeArray [[_v3float:%[a-zA-Z0-9_]+]]
// CHECK: [[__struct_5:%[a-zA-Z0-9_]+]] = OpTypeStruct [[__runtimearr_v3float:%[a-zA-Z0-9_]+]]
// CHECK: [[__ptr_StorageBuffer__struct_5:%[a-zA-Z0-9_]+]] = OpTypePointer StorageBuffer [[__struct_5:%[a-zA-Z0-9_]+]]
// CHECK: [[__struct_7:%[a-zA-Z0-9_]+]] = OpTypeStruct [[_v3float:%[a-zA-Z0-9_]+]]
...
// CHECK: [[_25:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v3float:%[a-zA-Z0-9_]+]] [[_20:%[a-zA-Z0-9_]+]] [[_uint_0:%[a-zA-Z0-9_]+]] [[_uint_0:%[a-zA-Z0-9_]+]]
// CHECK: [[_26:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v3float:%[a-zA-Z0-9_]+]] [[_21:%[a-zA-Z0-9_]+]] [[_uint_0:%[a-zA-Z0-9_]+]]
// CHECK: [[_27:%[a-zA-Z0-9_]+]] = OpLoad [[_v3float:%[a-zA-Z0-9_]+]] [[_26:%[a-zA-Z0-9_]+]]
// CHECK: [[_28:%[a-zA-Z0-9_]+]] = OpAccessChain [[__ptr_StorageBuffer_v3float:%[a-zA-Z0-9_]+]] [[_22:%[a-zA-Z0-9_]+]] [[_uint_0:%[a-zA-Z0-9_]+]]
// CHECK: [[_29:%[a-zA-Z0-9_]+]] = OpLoad [[_v3float:%[a-zA-Z0-9_]+]] [[_28:%[a-zA-Z0-9_]+]]
// CHECK: [[_30:%[a-zA-Z0-9_]+]] = OpFRem [[_v3float:%[a-zA-Z0-9_]+]] [[_27:%[a-zA-Z0-9_]+]] [[_29:%[a-zA-Z0-9_]+]]
