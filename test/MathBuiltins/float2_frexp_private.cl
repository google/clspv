...
// CHECK-DAG: %[[UINT_PRIVATE_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer Function %[[UINT_VECTOR_TYPE_ID]]
// CHECK-DAG: %[[CONSTANT_0_ID:[a-zA-Z0-9_]*]] = OpConstant %[[UINT_TYPE_ID]] 0
// CHECK-DAG: %[[null_uint2:[a-zA-Z0-9_]*]] = OpConstantNull %[[UINT_VECTOR_TYPE_ID]]
...
// CHECK: OpStore %[[PRIVATE_VAR_ID]] %[[null_uint2]]
