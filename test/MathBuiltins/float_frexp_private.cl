...
// CHECK: %[[UINT_PRIVATE_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer Function %[[UINT_TYPE_ID]]
...
// CHECK: %[[LOAD_PRIVATE_VAR_ID:[a-zA-Z0-9_]*]] = OpLoad %[[UINT_TYPE_ID]] %[[PRIVATE_VAR_ID]]
