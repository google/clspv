...
// CHECK: %[[CONSTANT_FLOAT_42_ID:[a-zA-Z0-9_]*]] = OpConstant %[[FLOAT_TYPE_ID]] 42
// CHECK: %[[COMPOSITE_FLOAT_42_ID:[a-zA-Z0-9_]*]] = OpConstantComposite %[[FLOAT_VECTOR_TYPE_ID]] %[[CONSTANT_FLOAT_42_ID]] %[[CONSTANT_FLOAT_42_ID]] %[[CONSTANT_FLOAT_42_ID]] %[[CONSTANT_FLOAT_42_ID]]
