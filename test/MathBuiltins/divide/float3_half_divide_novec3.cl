...
// CHECK-DAG: %[[UNDEF_VECTOR_FLOAT:[a-zA-Z0-9_]*]] = OpUndef %[[FLOAT_VECTOR_TYPE_ID]]
...
// CHECK: %[[OP_ID_SHUFFLE_UNDEF:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[FLOAT_VECTOR_TYPE_ID]] %[[OP_ID]] %[[UNDEF_VECTOR_FLOAT]] 0 1 2 4294967295
