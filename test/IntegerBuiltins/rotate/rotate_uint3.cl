...
// CHECK-DAG: %[[vecmodmask:[0-9]+]] = OpConstantComposite %[[v4uint]] %[[modmask]] %[[modmask]] %[[modmask]]
// CHECK-DAG: %[[scalarsize:[0-9a-zA-Z_]+]] = OpConstant %[[uint]] 32
// CHECK-DAG: %[[vecscalarbits:[0-9]+]] = OpConstantComposite %[[v4uint]] %[[scalarsize]] %[[scalarsize]] %[[scalarsize]]
