...
// CHECK-DAG: %[[vecmodmask:[0-9]+]] = OpConstantComposite %[[v4ushort]] %[[modmask]] %[[modmask]] %[[modmask]]
// CHECK-DAG: %[[scalarsize:[0-9a-zA-Z_]+]] = OpConstant %[[ushort]] 16
// CHECK-DAG: %[[vecscalarbits:[0-9]+]] = OpConstantComposite %[[v4ushort]] %[[scalarsize]] %[[scalarsize]] %[[scalarsize]]
