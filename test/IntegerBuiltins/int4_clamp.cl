...
// CHECK-DAG: %[[COMPOSITE_1_ID:[a-zA-Z0-9_]*]] = OpConstantComposite %[[UINT_VECTOR_TYPE_ID]] %[[CONSTANT_1_ID]] %[[CONSTANT_1_ID]] %[[CONSTANT_1_ID]] %[[CONSTANT_1_ID]]
...
void kernel __attribute__((reqd_work_group_size(1, 1, 1))) foo(global int4* a, global int4* b)
{
  *a = clamp(*b, 0, 1);
}
