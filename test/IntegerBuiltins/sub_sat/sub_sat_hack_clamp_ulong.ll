...
define i64 @sub_sat_ulong(i64 %a, i64 %b) {
entry:
 %call = call i64 @_Z7sub_satmm(i64 %a, i64 %b)
 ret i64 %call
}

declare i64 @_Z7sub_satmm(i64, i64)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { i64, i64 } @_Z8spirv.op.150.mm(i32 150, i64 %a, i64 %b)
...
; CHECK: [[sel:%[a-zA-Z0-9_.]+]] = select i1 [[cmp]], i64 [[ex0]], i64 0
; CHECK: ret i64 [[sel]]
