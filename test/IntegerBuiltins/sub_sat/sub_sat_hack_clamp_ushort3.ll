...
define <3 x i16> @sub_sat_ushort3(<3 x i16> %a, <3 x i16> %b) {
entry:
 %call = call <3 x i16> @_Z7sub_satDv3_tS_(<3 x i16> %a, <3 x i16> %b)
 ret <3 x i16> %call
}

declare <3 x i16> @_Z7sub_satDv3_tS_(<3 x i16>, <3 x i16>)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { <3 x i16>, <3 x i16> } @_Z8spirv.op.150.Dv3_tDv3_t(i32 150, <3 x i16> %a, <3 x i16> %b)
...
; CHECK: [[sel:%[a-zA-Z0-9_.]+]] = select <3 x i1> [[cmp]], <3 x i16> [[ex0]], <3 x i16> zeroinitializer
