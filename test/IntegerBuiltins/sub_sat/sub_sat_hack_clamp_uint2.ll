...
define <2 x i32> @sub_sat_uint2(<2 x i32> %a, <2 x i32> %b) {
entry:
 %call = call <2 x i32> @_Z7sub_satDv2_jS_(<2 x i32> %a, <2 x i32> %b)
 ret <2 x i32> %call
}

declare <2 x i32> @_Z7sub_satDv2_jS_(<2 x i32>, <2 x i32>)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { <2 x i32>, <2 x i32> } @_Z8spirv.op.150.Dv2_jDv2_j(i32 150, <2 x i32> %a, <2 x i32> %b)
...
; CHECK: [[sel:%[a-zA-Z0-9_.]+]] = select <2 x i1> [[cmp]], <2 x i32> [[ex0]], <2 x i32> zeroinitializer
