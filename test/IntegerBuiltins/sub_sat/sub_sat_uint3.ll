...
define <3 x i32> @sub_sat_uint3(<3 x i32> %a, <3 x i32> %b) {
entry:
 %call = call <3 x i32> @_Z7sub_satDv3_jS_(<3 x i32> %a, <3 x i32> %b)
 ret <3 x i32> %call
}

declare <3 x i32> @_Z7sub_satDv3_jS_(<3 x i32>, <3 x i32>)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { <3 x i32>, <3 x i32> } @_Z8spirv.op.150.Dv3_jDv3_j(i32 150, <3 x i32> %a, <3 x i32> %b)
...
; CHECK: [[sel:%[a-zA-Z0-9_.]+]] = select <3 x i1> [[cmp]], <3 x i32> [[ex0]], <3 x i32> zeroinitializer
