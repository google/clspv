...
define <3 x i16> @sub_sat_short3(<3 x i16> %a, <3 x i16> %b) {
entry:
 %call = call <3 x i16> @_Z7sub_satDv3_sS_(<3 x i16> %a, <3 x i16> %b)
 ret <3 x i16> %call
}

declare <3 x i16> @_Z7sub_satDv3_sS_(<3 x i16>, <3 x i16>)
