...
define <4 x i64> @sub_sat_long4(<4 x i64> %a, <4 x i64> %b) {
entry:
 %call = call <4 x i64> @_Z7sub_satDv4_lS_(<4 x i64> %a, <4 x i64> %b)
 ret <4 x i64> %call
}

declare <4 x i64> @_Z7sub_satDv4_lS_(<4 x i64>, <4 x i64>)

; CHECK: [[sub:%[a-zA-Z0-9_.]+]] = sub <4 x i64> %a, %b
