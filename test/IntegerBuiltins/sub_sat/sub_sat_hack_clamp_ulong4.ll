...
define <4 x i64> @sub_sat_ulong4(<4 x i64> %a, <4 x i64> %b) {
entry:
 %call = call <4 x i64> @_Z7sub_satDv4_mS_(<4 x i64> %a, <4 x i64> %b)
 ret <4 x i64> %call
}

declare <4 x i64> @_Z7sub_satDv4_mS_(<4 x i64>, <4 x i64>)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { <4 x i64>, <4 x i64> } @_Z8spirv.op.150.Dv4_mDv4_m(i32 150, <4 x i64> %a, <4 x i64> %b)
...
; CHECK: [[sel:%[a-zA-Z0-9_.]+]] = select <4 x i1> [[cmp]], <4 x i64> [[ex0]], <4 x i64> zeroinitializer
