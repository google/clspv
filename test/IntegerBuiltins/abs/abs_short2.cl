...
// CHECK-DAG: %[[_struct_5]] = OpTypeStruct %[[_runtimearr_v2ushort]]
...
// CHECK:     %[[__original_id_16:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v2ushort]] %[[__original_id_12]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_17:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v2ushort]] %[[__original_id_13]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_18:[0-9]+]] = OpLoad %[[v2ushort]] %[[__original_id_17]]
// CHECK:     %[[__original_id_19:[0-9]+]] = OpExtInst %[[v2ushort]] %[[__original_id_1]] SAbs %[[__original_id_18]]
