...
// CHECK:     %[[__original_id_14:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_ushort]] %[[__original_id_10]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_15:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_ushort]] %[[__original_id_11]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_16:[0-9]+]] = OpLoad %[[ushort]] %[[__original_id_15]]
