...
// CHECK:     %[[__original_id_15:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v4ushort]] %[[__original_id_11]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_16:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v4ushort]] %[[__original_id_12]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_17:[0-9]+]] = OpLoad %[[v4ushort]] %[[__original_id_16]]
