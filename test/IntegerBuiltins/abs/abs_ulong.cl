...
// CHECK:     %[[__original_id_12]] = OpFunction %[[void]] None %[[__original_id_6]]
// CHECK:     %[[__original_id_13:[0-9]+]] = OpLabel
// CHECK:     %[[__original_id_14:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_ulong]] %[[__original_id_10]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_15:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_ulong]] %[[__original_id_11]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_16:[0-9]+]] = OpLoad %[[ulong]] %[[__original_id_15]]
// CHECK:     OpStore %[[__original_id_14]] %[[__original_id_16]]
// CHECK:     OpReturn
// CHECK:     OpFunctionEnd
