...
define <4 x i16> @add_sat_ushort4(<4 x i16> %a, <4 x i16> %b) {
entry:
 %call = call <4 x i16> @_Z7add_satDv4_tS_(<4 x i16> %a, <4 x i16> %b)
 ret <4 x i16> %call
}

declare <4 x i16> @_Z7add_satDv4_tS_(<4 x i16>, <4 x i16>)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { <4 x i16>, <4 x i16> } @_Z8spirv.op.149.Dv4_tDv4_t(i32 149, <4 x i16> %a, <4 x i16> %b)
...
; CHECK: [[sel:%[a-zA-Z0-9_.]+]] = select <4 x i1> [[cmp]], <4 x i16> [[ex0]], <4 x i16> <i16 -1, i16 -1, i16 -1, i16 -1>
