...
define <4 x i32> @add_sat_uint4(<4 x i32> %a, <4 x i32> %b) {
entry:
 %call = call <4 x i32> @_Z7add_satDv4_jS_(<4 x i32> %a, <4 x i32> %b)
 ret <4 x i32> %call
}

declare <4 x i32> @_Z7add_satDv4_jS_(<4 x i32>, <4 x i32>)

; CHECK: [[call:%[a-zA-Z0-9_.]+]] = call { <4 x i32>, <4 x i32> } @_Z8spirv.op.149.Dv4_jDv4_j(i32 149, <4 x i32> %a, <4 x i32> %b)
