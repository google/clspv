...
define <3 x i8> @add_sat_char3(<3 x i8> %a, <3 x i8> %b) {
entry:
 %call = call <3 x i8> @_Z7add_satDv3_cS_(<3 x i8> %a, <3 x i8> %b)
 ret <3 x i8> %call
}

declare <3 x i8> @_Z7add_satDv3_cS_(<3 x i8>, <3 x i8>)

; CHECK: [[sext_a:%[a-zA-Z0-9_.]+]] = sext <3 x i8> %a to <3 x i16>
; CHECK: [[sext_b:%[a-zA-Z0-9_.]+]] = sext <3 x i8> %b to <3 x i16>
; CHECK: [[add:%[a-zA-Z0-9_.]+]] = add nsw <3 x i16> [[sext_a]], [[sext_b]]
