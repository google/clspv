...
define <2 x i16> @mad_sat_short2(<2 x i16> %a, <2 x i16> %b, <2 x i16> %c) {
entry:
 %call = call <2 x i16> @_Z7mad_satDv2_sS_S_(<2 x i16> %a, <2 x i16> %b, <2 x i16> %c)
 ret <2 x i16> %call
}

declare <2 x i16> @_Z7mad_satDv2_sS_S_(<2 x i16>, <2 x i16>, <2 x i16>)
