...
// CHECK:     %[[__original_id_22:[0-9]+]] = OpSGreaterThan %[[bool]] %[[__original_id_19]] %[[__original_id_18]]
// CHECK:     %[[__original_id_23:[0-9]+]] = OpSelect %[[uint]] %[[__original_id_22]] %[[__original_id_21]] %[[__original_id_20]]


kernel void __attribute__((reqd_work_group_size(1, 1, 1))) foo(global uint* a, global int* b, global int* c)
{
    *a = abs_diff(*b, *c);
}
