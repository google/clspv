...
// CHECK:     %[[__original_id_23:[0-9]+]] = OpISub %[[v2ulong]] %[[__original_id_21:[0-9]+]] %[[__original_id_22:[0-9]+]]
// CHECK:     %[[__original_id_24:[0-9]+]] = OpISub %[[v2ulong]] %[[__original_id_22]] %[[__original_id_21]]
// CHECK:     %[[__original_id_25:[0-9]+]] = OpUGreaterThan %[[v2bool]] %[[__original_id_22]] %[[__original_id_21]]
// CHECK:     %[[__original_id_26:[0-9]+]] = OpSelect %[[v2ulong]] %[[__original_id_25]] %[[__original_id_24]] %[[__original_id_23]]
