...
// CHECK:     %[[__original_id_21:[0-9]+]] = OpISub %[[uchar]] %[[__original_id_19:[0-9]+]] %[[__original_id_20:[0-9]+]]
// CHECK:     %[[__original_id_22:[0-9]+]] = OpISub %[[uchar]] %[[__original_id_20]] %[[__original_id_19]]
// CHECK:     %[[__original_id_23:[0-9]+]] = OpUGreaterThan %[[bool]] %[[__original_id_20]] %[[__original_id_19]]
// CHECK:     %[[__original_id_24:[0-9]+]] = OpSelect %[[uchar]] %[[__original_id_23]] %[[__original_id_22]] %[[__original_id_21]]
