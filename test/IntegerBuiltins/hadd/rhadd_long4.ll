...
define <4 x i64> @rhadd_long4(<4 x i64> %a, <4 x i64> %b) {
entry:
 %call = call <4 x i64> @_Z5rhaddDv4_lS_(<4 x i64> %a, <4 x i64> %b)
 ret <4 x i64> %call
}

declare <4 x i64> @_Z5rhaddDv4_lS_(<4 x i64>, <4 x i64>)

; CHECK: [[a_shr:%[a-zA_Z0-9_.]+]] = ashr <4 x i64> %a, splat (i64 1)
; CHECK: [[b_shr:%[a-zA-Z0-9_.]+]] = ashr <4 x i64> %b, splat (i64 1)
; CHECK: [[add:%[a-zA-Z0-9_.]+]] = add <4 x i64> [[a_shr]], [[b_shr]]
; CHECK: [[join:%[a-zA-Z0-9_.]+]] = or <4 x i64> %a, %b
; CHECK: [[and:%[a-zA-Z0-9_.]+]] = and <4 x i64> [[join]], splat (i64 1)
