...
define <3 x i64> @rhadd_ulong3(<3 x i64> %a, <3 x i64> %b) {
entry:
 %call = call <3 x i64> @_Z5rhaddDv3_mS_(<3 x i64> %a, <3 x i64> %b)
 ret <3 x i64> %call
}

declare <3 x i64> @_Z5rhaddDv3_mS_(<3 x i64>, <3 x i64>)

; CHECK: [[a_shr:%[a-zA_Z0-9_.]+]] = lshr <3 x i64> %a, splat (i64 1)
; CHECK: [[b_shr:%[a-zA-Z0-9_.]+]] = lshr <3 x i64> %b, splat (i64 1)
; CHECK: [[add:%[a-zA-Z0-9_.]+]] = add <3 x i64> [[a_shr]], [[b_shr]]
; CHECK: [[join:%[a-zA-Z0-9_.]+]] = or <3 x i64> %a, %b
; CHECK: [[and:%[a-zA-Z0-9_.]+]] = and <3 x i64> [[join]], splat (i64 1)
