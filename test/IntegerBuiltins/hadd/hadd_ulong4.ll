...
define <4 x i64> @hadd_ulong4(<4 x i64> %a, <4 x i64> %b) {
entry:
 %call = call <4 x i64> @_Z4haddDv4_mS_(<4 x i64> %a, <4 x i64> %b)
 ret <4 x i64> %call
}

declare <4 x i64> @_Z4haddDv4_mS_(<4 x i64>, <4 x i64>)

; CHECK: [[a_shr:%[a-zA_Z0-9_.]+]] = lshr <4 x i64> %a, splat (i64 1)
; CHECK: [[b_shr:%[a-zA-Z0-9_.]+]] = lshr <4 x i64> %b, splat (i64 1)
