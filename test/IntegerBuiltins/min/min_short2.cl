...
// CHECK:     %[[__original_id_17:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v2ushort]] %[[__original_id_12]] %[[uint_0]] %[[uint_0]]
...
// CHECK:     %[[__original_id_20:[0-9]+]] = OpLoad %[[v2ushort]] %[[__original_id_18]]
// CHECK:     %[[__original_id_21:[0-9]+]] = OpLoad %[[v2ushort]] %[[__original_id_19]]
// CHECK:     %[[__original_id_22:[0-9]+]] = OpExtInst %[[v2ushort]] %[[__original_id_1]] SMin %[[__original_id_20]] %[[__original_id_21]]
