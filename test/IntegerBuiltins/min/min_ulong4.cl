...
// CHECK-DAG: %[[_struct_5]] = OpTypeStruct %[[_runtimearr_v4ulong]]
...
// CHECK:     %[[__original_id_17:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v4ulong]] %[[__original_id_12]] %[[uint_0]] %[[uint_0]]
...
// CHECK:     %[[__original_id_20:[0-9]+]] = OpLoad %[[v4ulong]] %[[__original_id_18]]
// CHECK:     %[[__original_id_21:[0-9]+]] = OpLoad %[[v4ulong]] %[[__original_id_19]]
