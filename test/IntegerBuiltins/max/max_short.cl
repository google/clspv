...
// CHECK:     %[[__original_id_19:[0-9]+]] = OpLoad %[[ushort]] %[[__original_id_17]]
// CHECK:     %[[__original_id_20:[0-9]+]] = OpLoad %[[ushort]] %[[__original_id_18]]
// CHECK:     %[[__original_id_21:[0-9]+]] = OpExtInst %[[ushort]] %[[__original_id_1]] SMax %[[__original_id_19]] %[[__original_id_20]]
