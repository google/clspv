...
kernel void foo(read_only image2d_t data, global float4* out) {
  *out = read_imagef(data, (int2)(0, 0));
}
...
// CHECK: OpExtInst [[void]] [[import]] ArgumentSampledImage [[decl]] [[uint_0]] [[uint_0]] [[uint_0]] [[info]]
