...
; Only requires VariablePointersStorageBuffer because of selection in same buffer.
...
entry:
  ...
  %other = getelementptr { [0 x i32] }, ptr addrspace(1) %0, i32 0, i32 0, i32 1
  ...
  %in. = select i1 %cmp.i, ptr addrspace(1) %1, ptr addrspace(1) %other
