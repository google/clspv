...
; Phi between pointers from the same buffer only requires VariablePointersStorageBuffer.
...
define dso_local spir_kernel void @foo(ptr addrspace(1) nocapture readonly align 4 %in, ptr addrspace(1) nocapture writeonly align 4 %out, i32 %a, i32 %x, i32 %y) !clspv.pod_args_impl !8 {
entry:
  ...
  %3 = call ptr addrspace(6) @_Z14clspv.resource.2(i32 0, i32 2, i32 4, i32 2, i32 2, i32 0, { i32 } zeroinitializer)
  %4 = getelementptr { i32 }, ptr addrspace(6) %3, i32 0, i32 0
  %5 = load i32, ptr addrspace(6) %4, align 4
  %ptr1 = getelementptr { [0 x i32] }, ptr addrspace(1) %0, i32 0, i32 0, i32 1
  %cmp = icmp eq i32 %5, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @_Z8spirv.op.224.jjj(i32 224, i32 2, i32 2, i32 72)
  %ptr2 = getelementptr { [0 x i32] }, ptr addrspace(1) %0, i32 0, i32 0, i32 2
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %phi = phi ptr addrspace(1) [ %ptr1, %entry ], [ %ptr2, %if.then ]
  %storemerge = load i32, ptr addrspace(1) %phi, align 4
  store i32 %storemerge, ptr addrspace(1) %2, align 4
  ret void
}
