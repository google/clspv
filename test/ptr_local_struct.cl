...
// RUN: clspv %target %s -o %t.spv -cluster-pod-kernel-args=0 -arch=spir64
// RUN: spirv-dis -o %t2.spvasm %t.spv
...
// MAP-NEXT: kernel,foo,arg,LS,argOrdinal,3,argKind,local,arrayElemSize,4,arrayNumElemSpecId,4
// MAP-NOT: kernel
...
// CHECK-DAG:  [[__arr__struct_22_7:%[0-9a-zA-Z_]+]] = OpTypeArray [[_uint]] [[_7]]
...
// CHECK-64:   [[_51:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Workgroup_uint]] [[_6]] [[_ulong_1]]
// CHECK-32:   [[_51:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Workgroup_uint]] [[_6]] [[_uint_1]]
