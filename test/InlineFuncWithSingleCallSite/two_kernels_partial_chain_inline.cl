...
int func_3(global int *in, int n) { return in[n]; }
int func_2(global int *in, int n) { return func_3(in, n); }
int func_1(global int *in, int n) { return func_2(in, n); }
kernel void kernel_1(global int *in, global int *out, int n) {
  out[n] = func_1(in, n);
}
kernel void kernel_2(global int *in, global int *out, int n) {
  out[n] = func_1(in, n);
}
