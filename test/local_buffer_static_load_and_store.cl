...
// CHECK: %[[UINT_GLOBAL_AND_CONSTANT_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[UINT_TYPE_ID]]
...
// CHECK: %[[UINT_LOCAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer Workgroup %[[UINT_TYPE_ID]]
...
{
// CHECK: %[[ACCESS_CHAINA_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[UINT_GLOBAL_AND_CONSTANT_POINTER_TYPE_ID]] %[[ARG0_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_0_ID]]
// CHECK: %[[ACCESS_CHAINB_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[UINT_GLOBAL_AND_CONSTANT_POINTER_TYPE_ID]] %[[ARG1_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_0_ID]]
  local uint c;
// CHECK: %[[LOAD_ID:[a-zA-Z0-9_]*]] = OpLoad %[[UINT_TYPE_ID]] %[[ACCESS_CHAINA_ID]]
// CHECK: OpStore %[[C_ID]] %[[LOAD_ID]]
  c = *a;
// CHECK: OpStore %[[ACCESS_CHAINB_ID]] %[[LOAD_ID]]
  *b = c;
// CHECK: OpReturn
}
// CHECK: OpFunctionEnd
