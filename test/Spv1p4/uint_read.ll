...
declare spir_func <4 x i32> @_Z12read_imageui24opencl.image2d_rw_t.uintDv2_i(target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 2, 1), <2 x i32>)

define spir_kernel void @foo(<4 x i32> addrspace(1)* nocapture %out, target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 2, 1) %i) !clspv.pod_args_impl !11 {
entry:
...
declare target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 2, 1) @_Z14clspv.resource.1(i32, i32, i32, i32, i32, i32, target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 2, 1))
