...
declare <4 x i32> @_Z12read_imageui32opencl.image2d_ro_t.uint.sampled11ocl_samplerDv2_f(target("spirv.Image", i32, 1, 0, 0, 0, 1, 0, 0, 1), target("spirv.Sampler"), <2 x float>)

define spir_kernel void @foo(<4 x i32> addrspace(1)* nocapture %out, target("spirv.Image", i32, 1, 0, 0, 0, 1, 0, 0, 1) %i, target("spirv.Sampler") %s)!clspv.pod_args_impl !10 {
entry:
...
declare target("spirv.Image", i32, 1, 0, 0, 0, 1, 0, 0, 1) @_Z14clspv.resource.1(i32, i32, i32, i32, i32, i32, target("spirv.Image", i32, 1, 0, 0, 0, 1, 0, 0, 1))
