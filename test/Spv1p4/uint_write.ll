...
declare spir_func void @_Z13write_imageui24opencl.image2d_wo_t.uintDv2_iDv4_j(target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 1, 1), <2 x i32>, <4 x i32>)
...
declare target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 1, 1) @_Z14clspv.resource.0(i32, i32, i32, i32, i32, i32, target("spirv.Image", i32, 1, 0, 0, 0, 2, 0, 1, 1))
