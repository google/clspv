...
entry:
  %call = call spir_func i32 @_Z27get_image_channel_data_type14ocl_image2d_ro(%opencl.image2d_ro_t addrspace(1)* %img)
  ret i32 %call
}

declare spir_func i32 @_Z27get_image_channel_data_type14ocl_image2d_ro(%opencl.image2d_ro_t addrspace(1)* %0)
...
; CHECK:  call spir_func i32 @_Z27get_image_channel_data_type14ocl_image2d_ro
; CHECK:  ret i32
