...
declare spir_func i32 @_Z20get_image_array_size31opencl.image1d_array_rw_t.float(target("spirv.Image", float, 0, 0, 1, 0, 2, 0, 2, 0))

define spir_kernel void @foo(ptr addrspace(1) %out, target("spirv.Image", float, 0, 0, 1, 0, 2, 0, 2, 0) %img) {
entry:
