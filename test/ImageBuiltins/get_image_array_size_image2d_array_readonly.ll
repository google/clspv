...
declare spir_func i32 @_Z20get_image_array_size39opencl.image2d_array_ro_t.float.sampled(target("spirv.Image", float, 1, 0, 1, 0, 1, 0, 0, 0))

define spir_kernel void @foo(ptr addrspace(1) nocapture writeonly align 4 %out, target("spirv.Image", float, 1, 0, 1, 0, 1, 0, 0, 0) %img) {
entry:
...
declare target("spirv.Image", float, 1, 0, 1, 0, 1, 0, 0, 0) @_Z14clspv.resource.1(i32, i32, i32, i32, i32, i32, target("spirv.Image", float, 1, 0, 1, 0, 1, 0, 0, 0))
