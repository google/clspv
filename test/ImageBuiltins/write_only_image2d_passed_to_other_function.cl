...
// CHECK: %[[ARG1_STRUCT_TYPE_ID]] = OpTypeStruct %[[UINT2_TYPE_ID]]
// CHECK: %[[ARG1_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[ARG1_STRUCT_TYPE_ID]]
// CHECK: %[[UINT2_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[UINT2_TYPE_ID]]
...
// CHECK: %[[BAR_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeFunction %[[VOID_TYPE_ID]] %[[WRITE_ONLY_IMAGE_TYPE_ID]] %[[UINT2_TYPE_ID]] %[[FLOAT4_TYPE_ID]]
