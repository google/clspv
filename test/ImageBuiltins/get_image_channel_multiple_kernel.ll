...
define spir_kernel void @fct0(ptr addrspace(1) writeonly align 4 %dst, ptr addrspace(1) %image, { i32 } %podargs) {
entry:
...
define spir_kernel void @fct1(ptr addrspace(1) writeonly align 4 %dst, ptr addrspace(1) %image, { i32 } %podargs) {
entry:
  %0 = call ptr addrspace(1) @_Z14clspv.resource.0(i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, { [0 x i32] } zeroinitializer)
  %1 = getelementptr { [0 x i32] }, ptr addrspace(1) %0, i32 0, i32 0, i32 0
  %2 = call ptr addrspace(1) @_Z14clspv.resource.1(i32 0, i32 1, i32 6, i32 1, i32 1, i32 0, target("spirv.Image", float, 0, 0, 0, 0, 1, 0, 0, 0) undef)
...
define spir_kernel void @fct2(ptr addrspace(1) writeonly align 4 %dst, ptr addrspace(1) %image1, ptr addrspace(1) %image2, { i32 } %podargs) {
entry:
  %0 = call ptr addrspace(1) @_Z14clspv.resource.0(i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, { [0 x i32] } zeroinitializer)
  %1 = getelementptr { [0 x i32] }, ptr addrspace(1) %0, i32 0, i32 0, i32 0
  %2 = call ptr addrspace(1) @_Z14clspv.resource.1(i32 0, i32 1, i32 6, i32 1, i32 1, i32 0, target("spirv.Image", float, 0, 0, 0, 0, 1, 0, 0, 0) undef)
...
; CHECK: define spir_kernel void @fct0(ptr addrspace(1) writeonly align 4 %dst, ptr addrspace(1) %image, { i32 } %podargs) !push_constants_image_channel [[fct0_kernel:![^ ]+]]
...
; CHECK: define spir_kernel void @fct1(ptr addrspace(1) writeonly align 4 %dst, ptr addrspace(1) %image, { i32 } %podargs) !push_constants_image_channel [[fct1_kernel:![^ ]+]]
...
; CHECK: define spir_kernel void @fct2(ptr addrspace(1) writeonly align 4 %dst, ptr addrspace(1) %image1, ptr addrspace(1) %image2, { i32 } %podargs) !push_constants_image_channel [[fct2_kernel:![^ ]+]]
