...
// CHECK:  [[kernel0:%[^ ]+]] = OpExtInst %void {{.*}} Kernel [[fct0]]
// CHECK:  ImageArgumentInfoChannelOrderPushConstant [[kernel0]] %uint_1 %uint_4 %uint_4
// CHECK:  [[kernel1:%[^ ]+]] = OpExtInst %void {{.*}} Kernel [[fct1]]
// CHECK:  ImageArgumentInfoChannelDataTypePushConstant [[kernel1]] %uint_1 %uint_4 %uint_4
// CHECK:  [[kernel2:%[^ ]+]] = OpExtInst %void {{.*}} Kernel [[fct2]]
// CHECK-DAG:  ImageArgumentInfoChannelOrderPushConstant [[kernel2]] {{.*}} %uint_4 %uint_4
// CHECK-DAG:  ImageArgumentInfoChannelOrderPushConstant [[kernel2]] {{.*}} %uint_8 %uint_4
// CHECK-DAG:  ImageArgumentInfoChannelDataTypePushConstant [[kernel2]] {{.*}} %uint_12 %uint_4
