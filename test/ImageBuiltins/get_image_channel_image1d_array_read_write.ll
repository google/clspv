...
declare spir_func i32 @_Z23get_image_channel_order45opencl.image1d_array_rw_t.float(ptr addrspace(1) %0)

declare spir_func i32 @_Z27get_image_channel_data_type45opencl.image1d_array_rw_t.float(ptr addrspace(1) %0)
...
entry:
  ...
  %2 = call ptr addrspace(1) @_Z14clspv.resource.1(i32 0, i32 1, i32 6, i32 1, i32 1, i32 0, target("spirv.Image", 0, 0, 1, 0, 2, 0, 0, 0) undef)
  %call = tail call spir_func i32 @_Z23get_image_channel_order45opencl.image1d_array_rw_t.float(ptr addrspace(1) %2)
...
entry:
  ...
  %1 = getelementptr { [0 x i32] }, ptr addrspace(1) %0, i32 0, i32 0, i32 0
  %2 = call ptr addrspace(1) @_Z14clspv.resource.1(i32 0, i32 1, i32 6, i32 1, i32 1, i32 0, target("spirv.Image", 0, 0, 1, 0, 2, 0, 0, 0) undef)
  %call = tail call spir_func i32 @_Z27get_image_channel_data_type45opencl.image1d_array_rw_t.float(ptr addrspace(1) %2)
  store i32 %call, ptr addrspace(1) %1, align 4
  ret void
}
...
declare ptr addrspace(1) @_Z14clspv.resource.1(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, target("spirv.Image", 0, 0, 1, 0, 2, 0, 0, 0) %6)
...
; CHECK: tail call spir_func i32 @_Z23get_image_channel_order45opencl.image1d_array_rw_t.float(ptr addrspace(1) {{.*}}), !image_getter_push_constant_offset [[call:![^ ]+]]
...
; CHECK: tail call spir_func i32 @_Z27get_image_channel_data_type45opencl.image1d_array_rw_t.float(ptr addrspace(1) {{.*}}), !image_getter_push_constant_offset [[call:![^ ]+]]
