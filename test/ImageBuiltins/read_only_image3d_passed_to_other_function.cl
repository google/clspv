...
// CHECK: %[[READ_ONLY_IMAGE_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeImage %[[FLOAT_TYPE_ID]] 3D 0 0 0 1 Unknown
...
// CHECK: %[[ARG2_STRUCT_TYPE_ID]] = OpTypeStruct %[[FLOAT4_TYPE_ID]]
...
// CHECK: %[[BAR_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeFunction %[[FLOAT4_TYPE_ID]] %[[SAMPLER_TYPE_ID]] %[[READ_ONLY_IMAGE_TYPE_ID]] %[[FLOAT4_TYPE_ID]]
