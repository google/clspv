...
// CHECK-DAG:  [[_18:%[0-9a-zA-Z_]+]] = OpTypeFunction [[_v4float]] [[_2]] [[_4]] [[_v2float]]
// CHECK-DAG:  [[_19:%[0-9a-zA-Z_]+]] = OpTypeSampledImage [[_4]]
// CHECK-DAG:  [[_uint_0:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 0
// CHECK-DAG:  [[_float_0:%[0-9a-zA-Z_]+]] = OpConstant [[_float]] 0
// CHECK-DAG:  [[_22]] = OpVariable [[__ptr_UniformConstant_2]] UniformConstant
// CHECK-DAG:  [[_23]] = OpVariable [[__ptr_UniformConstant_4]] UniformConstant
// CHECK-DAG:  [[_24]] = OpVariable [[__ptr_StorageBuffer__struct_7]] StorageBuffer
// CHECK-DAG:  [[_25]] = OpVariable [[__ptr_StorageBuffer__struct_11]] StorageBuffer
