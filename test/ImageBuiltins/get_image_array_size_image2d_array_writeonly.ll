...
declare spir_func i32 @_Z20get_image_array_size31opencl.image2d_array_wo_t.float(ptr addrspace(1))
...
entry:
  ...
  %2 = call ptr addrspace(1) @_Z14clspv.resource.1(i32 0, i32 1, i32 7, i32 1, i32 1, i32 0, %opencl.image2d_array_wo_t.float zeroinitializer)
  %call = tail call spir_func i32 @_Z20get_image_array_size31opencl.image2d_array_wo_t.float(ptr addrspace(1) %2)
...
declare ptr addrspace(1) @_Z14clspv.resource.1(i32, i32, i32, i32, i32, i32, %opencl.image2d_array_wo_t.float)
