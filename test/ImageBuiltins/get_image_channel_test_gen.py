...
declare spir_func i32 ${order_function}(${image_type} addrspace(1)* %0)

declare spir_func i32 ${data_type_function}(${image_type} addrspace(1)* %0)

define spir_kernel void @order(i32 addrspace(1)* nocapture writeonly align 4 %dst, ${image_type} addrspace(1)* %image) {
entry:
  ...
  %2 = call ${image_type} addrspace(1)* @_Z14clspv.resource.1(i32 0, i32 1, i32 6, i32 1, i32 1, i32 0, ${image_type} zeroinitializer)
  %call = tail call spir_func i32 ${order_function}(${image_type} addrspace(1)* %2)
  store i32 %call, i32 addrspace(1)* %1, align 4
  ret void
}

define spir_kernel void @data_type(i32 addrspace(1)* nocapture writeonly align 4 %dst, ${image_type} addrspace(1)* %image) {
entry:
  %0 = call { [0 x i32] } addrspace(1)* @_Z14clspv.resource.0(i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, { [0 x i32] } zeroinitializer)
  %1 = getelementptr { [0 x i32] }, { [0 x i32] } addrspace(1)* %0, i32 0, i32 0, i32 0
  %2 = call ${image_type} addrspace(1)* @_Z14clspv.resource.1(i32 0, i32 1, i32 6, i32 1, i32 1, i32 0, ${image_type} zeroinitializer)
  %call = tail call spir_func i32 ${data_type_function}(${image_type} addrspace(1)* %2)
  store i32 %call, i32 addrspace(1)* %1, align 4
  ret void
}
...
declare ${image_type} addrspace(1)* @_Z14clspv.resource.1(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, ${image_type} %6)
...
; CHECK: tail call spir_func i32 ${order_function}({{.*}} addrspace(1)* {{.*}}), !image_getter_push_constant_offset [[call:![^ ]+]]
...
; CHECK: tail call spir_func i32 ${data_type_function}({{.*}} addrspace(1)* {{.*}}), !image_getter_push_constant_offset [[call:![^ ]+]]
