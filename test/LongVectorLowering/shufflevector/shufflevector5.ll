...
entry:
  %x = shufflevector <3 x i32> %a, <3 x i32> zeroinitializer, <8 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 poison, i32 5, i32 4, i32 3>
  ret <8 x i32> %x
}
...
; CHECK-DAG: [[TMP0:%[^ ]+]] = insertvalue [[INT8]] poison, i32 [[S0]], 0
; CHECK-DAG: [[TMP1:%[^ ]+]] = insertvalue [[INT8]] [[TMP0]], i32 [[S1]], 1
; CHECK-DAG: [[TMP2:%[^ ]+]] = insertvalue [[INT8]] [[TMP1]], i32 [[S2]], 2
; CHECK-DAG: [[TMP5:%[^ ]+]] = insertvalue [[INT8]] [[TMP2]], i32 0, 5
