...
; CHECK-NEXT: [[TMP0:%[^ ]+]] = insertvalue [8 x i8] poison, i8 [[Y0]], 0
...
; CHECK-NEXT: [[TMP0:%[^ ]+]] = insertelement <4 x i8> poison, i8 [[X0]], i64 0
...
; CHECK-NEXT: [[TMP4:%[^ ]+]] = insertelement <4 x i8> poison, i8 [[X4]], i64 0
...
; CHECK-NEXT: [[TMP2:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X2]], i64 0
; CHECK-NEXT: [[TMP3:%[^ ]+]] = insertelement <2 x i32> [[TMP2]], i32 [[X3]], i64 1
; CHECK-NEXT: [[TMP4:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X4]], i64 0
; CHECK-NEXT: [[TMP5:%[^ ]+]] = insertelement <2 x i32> [[TMP4]], i32 [[X5]], i64 1
; CHECK-NEXT: [[TMP6:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X6]], i64 0
; CHECK-NEXT: [[TMP7:%[^ ]+]] = insertelement <2 x i32> [[TMP6]], i32 [[X7]], i64 1
; CHECK-NEXT: [[TMP8:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X8]], i64 0
; CHECK-NEXT: [[TMP9:%[^ ]+]] = insertelement <2 x i32> [[TMP8]], i32 [[X9]], i64 1
; CHECK-NEXT: [[TMP10:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X10]], i64 0
; CHECK-NEXT: [[TMP11:%[^ ]+]] = insertelement <2 x i32> [[TMP10]], i32 [[X11]], i64 1
; CHECK-NEXT: [[TMP12:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X12]], i64 0
; CHECK-NEXT: [[TMP13:%[^ ]+]] = insertelement <2 x i32> [[TMP12]], i32 [[X13]], i64 1
; CHECK-NEXT: [[TMP14:%[^ ]+]] = insertelement <2 x i32> poison, i32 [[X14]], i64 0
...
; CHECK-NEXT: [[TMP0:%[^ ]+]] = insertvalue [8 x i64] poison, i64 [[Y0]], 0
...
; CHECK-NEXT: [[TMP4:%[^ ]+]] = insertelement <4 x i32> poison, i32 [[X4]], i64 0
...
; CHECK-DAG: [[TMP0:%[^ ]+]] = insertvalue [[OUT]] poison, i32 [[Y0]], 0
