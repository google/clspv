...
; CHECK-DAG: [[add0:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a0]], i8 [[ex_b0]])
; CHECK-DAG: [[add1:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a1]], i8 [[ex_b1]])
; CHECK-DAG: [[add2:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a2]], i8 [[ex_b2]])
; CHECK-DAG: [[add3:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a3]], i8 [[ex_b3]])
; CHECK-DAG: [[add4:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a4]], i8 [[ex_b4]])
; CHECK-DAG: [[add5:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a5]], i8 [[ex_b5]])
; CHECK-DAG: [[add6:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a6]], i8 [[ex_b6]])
; CHECK-DAG: [[add7:%[a-zA-Z0-9_.]+]] = call %0 @_Z13spirv.op.149.hh(i32 149, i8 [[ex_a7]], i8 [[ex_b7]])
