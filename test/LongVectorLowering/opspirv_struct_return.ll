...
define spir_func void @test8(<8 x i32>* %a, <8 x i32>* %b, <8 x i32>* %c, <8 x i32>* %d) {
entry:
  %0 = load <8 x i32>, <8 x i32>* %a, align 32
  %1 = load <8 x i32>, <8 x i32>* %b, align 32
  ...
  store <8 x i32> %3, <8 x i32>* %c, align 32
  store <8 x i32> %4, <8 x i32>* %d, align 32
  ret void
}
...
; CHECK: [[loada:%[^ ]+]] = load [8 x i32], [8 x i32]* %a, align 32
; CHECK: [[loadb:%[^ ]+]] = load [8 x i32], [8 x i32]* %b, align 32
