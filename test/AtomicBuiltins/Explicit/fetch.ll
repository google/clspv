...
; CHECK: call i32 @_Z8spirv.op.234.{{.*}}(i32 234, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.234.{{.*}}(i32 234, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.235.{{.*}}(i32 235, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.235.{{.*}}(i32 235, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.235.{{.*}}(i32 235, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.241.{{.*}}(i32 241, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.241.{{.*}}(i32 241, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.241.{{.*}}(i32 241, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.242.{{.*}}(i32 242, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.242.{{.*}}(i32 242, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.242.{{.*}}(i32 242, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.240.{{.*}}(i32 240, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.240.{{.*}}(i32 240, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.240.{{.*}}(i32 240, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.236.{{.*}}(i32 236, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.236.{{.*}}(i32 236, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.236.{{.*}}(i32 236, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.237.{{.*}}(i32 237, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.237.{{.*}}(i32 237, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.237.{{.*}}(i32 237, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.238.{{.*}}(i32 238, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.238.{{.*}}(i32 238, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.238.{{.*}}(i32 238, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
; CHECK: call i32 @_Z8spirv.op.239.{{.*}}(i32 239, ptr addrspace(1) %atomic, i32 1, i32 72, i32 100)
; CHECK: call i32 @_Z8spirv.op.239.{{.*}}(i32 239, ptr addrspace(1) %atomic, i32 1, i32 64, i32 101)
; CHECK: call i32 @_Z8spirv.op.239.{{.*}}(i32 239, ptr addrspace(1) %atomic, i32 3, i32 64, i32 102)
