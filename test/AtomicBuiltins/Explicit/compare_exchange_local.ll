...
; CHECK: [[fi]]:
; CHECK: [[load_expected:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(3) %expected
; CHECK: [[cmp_xchg:%[a-zA-Z0-9_.]+]] = call i32 @_Z8spirv.op.230.{{.*}}(i32 230, ptr addrspace(3) %atomic, i32 2, i32 0, i32 0, i32 998, i32 [[load_expected]])
...
; CHECK: [[fi]]:
; CHECK: [[load_expected:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(3) %expected
; CHECK: [[cmp_xchg:%[a-zA-Z0-9_.]+]] = call i32 @_Z8spirv.op.230.{{.*}}(i32 230, ptr addrspace(3) %atomic, i32 3, i32 258, i32 0, i32 997, i32 [[load_expected]])
