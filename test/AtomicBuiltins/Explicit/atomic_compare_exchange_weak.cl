...
kernel void foo(global bool* out, global atomic_int* a, local atomic_int* b) {
    ...
    *out = atomic_compare_exchange_weak(a, &expected, 7);
    ...
    *out = atomic_compare_exchange_weak_explicit(a, &expected, 7, memory_order_relaxed, memory_order_relaxed, memory_scope_device);
    ...
    *out = atomic_compare_exchange_weak_explicit(a, &expected, 7, memory_order_relaxed, memory_order_relaxed, memory_scope_work_group);

    *out = atomic_compare_exchange_weak(b, &expected, 7);
    ...
    *out = atomic_compare_exchange_weak_explicit(b, &expected, 7, memory_order_relaxed, memory_order_relaxed, memory_scope_device);
    ...
    *out = atomic_compare_exchange_weak_explicit(b, &expected, 7, memory_order_relaxed, memory_order_relaxed, memory_scope_work_group);
}
