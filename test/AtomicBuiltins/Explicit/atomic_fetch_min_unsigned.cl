...
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[AcqRel_Uniform]] [[value]]

// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[AcqRel_Uniform]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[Rel_Uniform]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[Acq_Uniform]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[Rx]] [[value]]

// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[AcqRel_Uniform]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[Rel_Uniform]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[Acq_Uniform]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[Rx]] [[value]]

// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[AcqRel_Workgroup]] [[value]]

// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[AcqRel_Workgroup]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[Rel_Workgroup]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[Acq_Workgroup]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[dv]] [[Rx]] [[value]]

// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[AcqRel_Workgroup]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[Rel_Workgroup]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[Acq_Workgroup]] [[value]]
// CHECK: OpAtomicUMin [[uint]] {{.*}} [[wg]] [[Rx]] [[value]]
