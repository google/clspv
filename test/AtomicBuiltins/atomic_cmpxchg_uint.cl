...
// CHECK: %[[ATOMIC_OP_ID:[a-zA-Z0-9_]*]] = OpAtomicCompareExchange %[[UINT_TYPE_ID]] %[[B_ACCESS_CHAIN_ID]] %[[CONSTANT_1_ID]] %[[CONSTANT_0x050_ID]] %[[CONSTANT_0x050_ID]] %[[CONSTANT_42_ID]] %[[CONSTANT_13_ID]]
