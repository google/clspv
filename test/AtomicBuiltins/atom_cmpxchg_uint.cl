...
// CHECK:     %[[__original_id_18:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_uint]] %[[__original_id_14]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_19:[0-9]+]] = OpAtomicCompareExchange %[[uint]] %[[__original_id_18]] %[[uint_1]] %[[uint_80]] %[[uint_80]] %[[uint_31]] %[[uint_42]]
// CHECK:     OpStore %[[__original_id_17]] %[[__original_id_19]]
// CHECK:     OpReturn
// CHECK:     OpFunctionEnd
