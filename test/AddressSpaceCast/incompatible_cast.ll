...
; CHECK: getelementptr inbounds float, ptr addrspace(3) null
; CHECK-NOT: addrspacecast
...
for.cond.i:                                       ; preds = %for.body.i, %entry
  %j.0.i = phi i32 [ 0, %entry ], [ %inc.i, %for.body.i ]
  %res.0.i = phi float [ 0.000000e+00, %entry ], [ %add.i, %for.body.i ]
  %cmp.i = icmp ult i32 %j.0.i, %3
  br i1 %cmp.i, label %for.body.i, label %_Z4loopPU3AS4Kfj.exit

for.body.i:                                       ; preds = %for.cond.i
  %5 = addrspacecast ptr addrspace(4) %4 to ptr addrspace(3)
  %arrayidx.i = getelementptr inbounds float, ptr addrspace(3) %5, i32 %j.0.i
  %6 = load float, ptr addrspace(3) %arrayidx.i, align 4
  %add.i = fadd float %res.0.i, %6
  %inc.i = add i32 %j.0.i, 1
  br label %for.cond.i, !llvm.loop !12

_Z4loopPU3AS4Kfj.exit:                            ; preds = %for.cond.i
