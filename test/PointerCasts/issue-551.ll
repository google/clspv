...
entry:
  ...
  ; CHECK: [[gep:%[a-zA-Z0-9_]+]] = getelementptr i8, ptr addrspace(1) %in, i32 0
  ; CHECK: [[gep1:%[a-zA-Z0-9_]+]] = getelementptr i8, ptr addrspace(1) [[gep]], i32 0
  ; CHECK: [[val1:%[a-zA-Z0-9_]+]] = load i8, ptr addrspace(1) [[gep1]]
  ; CHECK: [[gep2:%[a-zA-Z0-9_]+]] = getelementptr i8, ptr addrspace(1) [[gep]], i32 1
