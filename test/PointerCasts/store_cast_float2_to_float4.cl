...
// CHECK: %[[BXY_ID:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[FLOAT2_TYPE_ID]] %[[B_LOAD_ID]] %[[UNDEF_ID]] 0 1
// CHECK: %[[BZW_ID:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[FLOAT2_TYPE_ID]] %[[B_LOAD_ID]] %[[UNDEF_ID]] 2 3
