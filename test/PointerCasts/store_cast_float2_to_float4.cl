...
// CHECK:  [[_29:%[0-9a-zA-Z_]+]] = OpLoad [[_v4float]] [[_26]]
// CHECK:  [[_30:%[0-9a-zA-Z_]+]] = OpShiftLeftLogical [[_uint]] [[_28]] [[_uint_1]]
// CHECK:  [[_31:%[0-9a-zA-Z_]+]] = OpVectorShuffle [[_v2float]] [[_29]] [[_20]] 0 1
// CHECK:  [[_32:%[0-9a-zA-Z_]+]] = OpVectorShuffle [[_v2float]] [[_29]] [[_20]] 2 3
// CHECK:  [[_33:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_21]] [[_uint_0]] [[_30]]
// CHECK:  OpStore [[_33]] [[_31]]
// CHECK:  [[_34:%[0-9a-zA-Z_]+]] = OpIAdd [[_uint]] [[_30]] [[_uint_1]]
// CHECK:  [[_35:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_21]] [[_uint_0]] [[_34]]
// CHECK:  OpStore [[_35]] [[_32]]
// CHECK:  OpReturn
// CHECK:  OpFunctionEnd
