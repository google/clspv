...
// CHECK: %[[ARG0_STRUCT_TYPE_ID]] = OpTypeStruct %[[UINT2_DYNAMIC_ARRAY_TYPE_ID]]
...
// CHECK: %[[A_INDEX:[a-zA-Z0-9_]*]] = OpShiftLeftLogical %[[UINT_TYPE_ID]] %[[I_LOAD_ID]] %[[CONSTANT_1_ID]]
// CHECK: %[[A_ACCESS_CHAIN_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[UINT2_GLOBAL_POINTER_TYPE_ID]] %[[ARG0_ID]] %[[CONSTANT_0_ID]] %[[A_INDEX]]
// CHECK: %[[A_LOAD_ID:[a-zA-Z0-9_]*]] = OpLoad %[[UINT2_TYPE_ID]] %[[A_ACCESS_CHAIN_ID]]

// CHECK: %[[A_1_INDEX:[a-zA-Z0-9_]*]] = OpIAdd %[[UINT_TYPE_ID]] %[[A_INDEX]] %[[CONSTANT_1_ID]]
// CHECK: %[[A_1_ACCESS_CHAIN_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[UINT2_GLOBAL_POINTER_TYPE_ID]] %[[ARG0_ID]] %[[CONSTANT_0_ID]] %[[A_1_INDEX]]
// CHECK: %[[A_1_LOAD_ID:[a-zA-Z0-9_]*]] = OpLoad %[[UINT2_TYPE_ID]] %[[A_1_ACCESS_CHAIN_ID]]

// CHECK: %[[LOAD_ID:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[UINT4_TYPE_ID]] %[[A_LOAD_ID]] %[[A_1_LOAD_ID]] 0 1 2 3

// CHECK: %[[BITCAST_ID:[a-zA-Z0-9_]*]] = OpBitcast %[[FLOAT4_TYPE_ID]] %[[LOAD_ID]]
