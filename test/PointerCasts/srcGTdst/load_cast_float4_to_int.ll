...
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr <4 x float>, ptr addrspace(1) %0, i32 0, i32 0
; CHECK: [[gep2:%[a-zA-Z0-9_.]+]] = getelementptr float, ptr addrspace(1) [[gep]], i32 %i
; CHECK: [[gep3:%[a-zA-Z0-9_.]+]] = getelementptr float, ptr addrspace(1) [[gep2]], i32 0
; CHECK: [[ld0:%[a-zA-Z0-9_.]+]] = load float, ptr addrspace(1) [[gep3]]
