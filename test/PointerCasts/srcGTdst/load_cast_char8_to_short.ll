...
; CHECK:  [[gep:%[^ ]+]] = getelementptr [8 x i8], [8 x i8] addrspace(1)* %b, i32 [[lshr]], i32 [[and]]
; CHECK:  [[ld0:%[^ ]+]] = load i8, i8 addrspace(1)* [[gep]]
; CHECK:  [[add:%[^ ]+]] = add i32 [[and]], 1
; CHECK:  [[gep:%[^ ]+]] = getelementptr [8 x i8], [8 x i8] addrspace(1)* %b, i32 [[lshr]], i32 [[add]]
...
entry:
  %0 = bitcast [8 x i8] addrspace(1)* %b to i16 addrspace(1)*
