...
// CHECK:  [[_21:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_float]] [[_17]] [[_uint_0]] [[_uint_0]]
// CHECK:  [[_22:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_18]] [[_uint_0]]
// CHECK:  [[_23:%[0-9a-zA-Z_]+]] = OpLoad [[_uint]] [[_22]]
// CHECK:  [[_24:%[0-9a-zA-Z_]+]] = OpLoad [[_float]] [[_21]]
// CHECK:  [[_25:%[0-9a-zA-Z_]+]] = OpBitcast [[_uint]] [[_24]]
// CHECK:  [[_26:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_16]] [[_uint_0]] [[_23]]
