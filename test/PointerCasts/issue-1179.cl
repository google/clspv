// RUN: clspv %s -o %t.spv -physical-storage-buffers -arch=spirv64 -cl-kernel-arg-info
// RUN: spirv-dis %t.spv -o %t.spvasm
// RUN: spirv-val %t.spv  --target-env spv1.0

// RUN: clspv %s -o %t.spv -physical-storage-buffers -arch=spirv64 -cl-kernel-arg-info -untyped-pointers
// RUN: spirv-dis %t.spv -o %t.spvasm
// RUN: spirv-val %t.spv  --target-env spv1.0
