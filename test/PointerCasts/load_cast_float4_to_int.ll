...
; CHECK: bitcast float [[ex0]] to i32
define spir_kernel void @foo(i32 addrspace(1)* %a, <4 x float> addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast <4 x float> addrspace(1)* %b to i32 addrspace(1)*
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %0, i32 %i
  %1 = load i32, i32 addrspace(1)* %arrayidx, align 8
  store i32 %1, i32 addrspace(1)* %a, align 8
  ret void
}
