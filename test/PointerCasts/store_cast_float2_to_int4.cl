...
// CHECK:  [[__struct_9]] = OpTypeStruct [[__runtimearr_v4uint]]
...
// CHECK:  [[_30:%[0-9a-zA-Z_]+]] = OpLoad [[_v4uint]] [[_27]]
...
// CHECK:  [[_35:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_22]] [[_uint_0]] [[_31]]
// CHECK:  OpStore [[_35]] [[_33]]
// CHECK:  [[_36:%[0-9a-zA-Z_]+]] = OpIAdd [[_uint]] [[_31]] [[_uint_1]]
// CHECK:  [[_37:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_v2float]] [[_22]] [[_uint_0]] [[_36]]
