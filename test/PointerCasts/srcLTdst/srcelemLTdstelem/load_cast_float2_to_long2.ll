...
define spir_kernel void @foo(<2 x float> addrspace(1)* %a, <2 x i64> addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast <2 x float> addrspace(1)* %a to <2 x i64> addrspace(1)*
  %arrayidx = getelementptr inbounds <2 x i64>, <2 x i64> addrspace(1)* %0, i32 %i
  %1 = load <2 x i64>, <2 x i64> addrspace(1)* %arrayidx, align 8
  store <2 x i64> %1, <2 x i64> addrspace(1)* %b, align 8
  ret void
}
