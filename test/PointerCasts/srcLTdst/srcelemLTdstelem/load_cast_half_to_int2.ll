...
; CHECK: bitcast <4 x half> [[ret3]] to <2 x i32>
define spir_kernel void @foo(half addrspace(1)* %a, <2 x i32> addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast half addrspace(1)* %a to <2 x i32> addrspace(1)*
