...
; CHECK: bitcast <4 x half> [[in]] to i64
define spir_kernel void @foo(<2 x half> addrspace(1)* %a, i64 addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast <2 x half> addrspace(1)* %a to i64 addrspace(1)*
