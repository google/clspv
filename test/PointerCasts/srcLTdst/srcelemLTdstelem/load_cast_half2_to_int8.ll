...
; CHECK: [[gep:%[^ ]+]] = getelementptr <2 x half>, ptr addrspace(1) %0, i32 [[add2]]
; CHECK: [[ld2:%[^ ]+]] = load <2 x half>, ptr addrspace(1) [[gep]]
; CHECK: [[add3:%[^ ]+]] = add i32 [[add2]], 1
; CHECK: [[gep:%[^ ]+]] = getelementptr <2 x half>, ptr addrspace(1) %0, i32 [[add3]]
; CHECK: [[ld3:%[^ ]+]] = load <2 x half>, ptr addrspace(1) [[gep]]
; CHECK: [[add4:%[^ ]+]] = add i32 [[add3]], 1
; CHECK: [[gep:%[^ ]+]] = getelementptr <2 x half>, ptr addrspace(1) %0, i32 [[add4]]
; CHECK: [[ld4:%[^ ]+]] = load <2 x half>, ptr addrspace(1) [[gep]]
; CHECK: [[add5:%[^ ]+]] = add i32 [[add4]], 1
; CHECK: [[gep:%[^ ]+]] = getelementptr <2 x half>, ptr addrspace(1) %0, i32 [[add5]]
; CHECK: [[ld5:%[^ ]+]] = load <2 x half>, ptr addrspace(1) [[gep]]
; CHECK: [[add6:%[^ ]+]] = add i32 [[add5]], 1
; CHECK: [[gep:%[^ ]+]] = getelementptr <2 x half>, ptr addrspace(1) %0, i32 [[add6]]
; CHECK: [[ld6:%[^ ]+]] = load <2 x half>, ptr addrspace(1) [[gep]]
; CHECK: [[add7:%[^ ]+]] = add i32 [[add6]], 1
; CHECK: [[gep:%[^ ]+]] = getelementptr <2 x half>, ptr addrspace(1) %0, i32 [[add7]]
; CHECK: [[ld7:%[^ ]+]] = load <2 x half>, ptr addrspace(1) [[gep]]
