...
; CHECK:  [[ret0:%[^ ]+]] = insertvalue [8 x i16] undef, i16 [[val0]], 0
...
define spir_kernel void @foo(<2 x i32> addrspace(1)* %a, [8 x i16] addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast <2 x i32> addrspace(1)* %a to [8 x i16] addrspace(1)*
