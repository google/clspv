...
; CHECK: bitcast <2 x float> [[in1]] to <4 x half>
define spir_kernel void @foo(float addrspace(1)* %a, <4 x half> addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast float addrspace(1)* %a to <4 x half> addrspace(1)*
