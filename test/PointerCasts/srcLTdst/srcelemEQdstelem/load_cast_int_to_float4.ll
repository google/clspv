...
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr i32, ptr addrspace(1) %0, i32 [[shl]]
; CHECK: [[ld0:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(1) [[gep]]
; CHECK: [[add0:%[a-zA-Z0-9_.]+]] = add i32 [[shl]], 1
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr i32, ptr addrspace(1) %0, i32 [[add0]]
; CHECK: [[ld1:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(1) [[gep]]
; CHECK: [[add1:%[a-zA-Z0-9_.]+]] = add i32 [[add0]], 1
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr i32, ptr addrspace(1) %0, i32 [[add1]]
; CHECK: [[ld2:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(1) [[gep]]
; CHECK: [[add2:%[a-zA-Z0-9_.]+]] = add i32 [[add1]], 1
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr i32, ptr addrspace(1) %0, i32 [[add2]]
; CHECK: [[ld3:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(1) [[gep]]
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <4 x i32> poison, i32 [[ld0]], i32 0
...
entry:
  ...
  %1 = load <4 x float>, ptr addrspace(1) %arrayidx, align 8
  store <4 x float> %1, ptr addrspace(1) %b, align 8
  ret void
}
