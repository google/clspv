...
; CHECK: [[shuffle0:%[a-zA-Z0-9_.]+]] = shufflevector <4 x float> [[cast]], <4 x float> poison, <2 x i32> <i32 0, i32 1>
; CHECK: [[shuffle1:%[a-zA-Z0-9_.]+]] = shufflevector <4 x float> [[cast]], <4 x float> poison, <2 x i32> <i32 2, i32 3>
