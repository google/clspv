...
// CHECK: %[[A_ACCESS_CHAIN_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT2_GLOBAL_POINTER_TYPE_ID]] %[[ARG0_ID]] %[[CONSTANT_0_ID]] %[[A_INDEX]]
// CHECK: %[[A_LOAD_ID:[a-zA-Z0-9_]*]] = OpLoad %[[FLOAT2_TYPE_ID]] %[[A_ACCESS_CHAIN_ID]]

// CHECK: %[[A_1_INDEX:[a-zA-Z0-9_]*]] = OpIAdd %[[UINT_TYPE_ID]] %[[A_INDEX]] %[[CONSTANT_1_ID]]
// CHECK: %[[A_1_ACCESS_CHAIN_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT2_GLOBAL_POINTER_TYPE_ID]] %[[ARG0_ID]] %[[CONSTANT_0_ID]] %[[A_1_INDEX]]
// CHECK: %[[A_1_LOAD_ID:[a-zA-Z0-9_]*]] = OpLoad %[[FLOAT2_TYPE_ID]] %[[A_1_ACCESS_CHAIN_ID]]

// CHECK: %[[LOAD_ID:[a-zA-Z0-9_]*]] = OpVectorShuffle %[[FLOAT4_TYPE_ID]] %[[A_LOAD_ID]] %[[A_1_LOAD_ID]] 0 1 2 3
