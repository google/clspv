...
// CHECK: OpDecorate %[[UINT2_DYNAMIC_ARRAY_TYPE_ID:[a-zA-Z0-9_]*]] ArrayStride 8
...
// CHECK: %[[UINT2_GLOBAL_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[UINT2_TYPE_ID]]
// CHECK: %[[UINT2_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[UINT2_TYPE_ID]]
// CHECK: %[[ARG1_STRUCT_TYPE_ID]] = OpTypeStruct %[[UINT2_DYNAMIC_ARRAY_TYPE_ID]]
...
// CHECK: %[[B_ACCESS_CHAIN_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[UINT2_GLOBAL_POINTER_TYPE_ID]] %[[ARG1_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_0_ID]]
...
// CHECK: %[[A_INDEX_ID:[a-zA-Z0-9_]*]] = OpShiftLeftLogical %[[UINT_TYPE_ID]] %[[I_LOAD_ID]] %[[CONSTANT_1_ID]]
...
// CHECK: %[[INSERT_0_ID:[a-zA-Z0-9_]*]] = OpCompositeInsert %[[FLOAT2_TYPE_ID]] %[[A_LOAD_ID]] %[[UNDEF_ID]] 0
// CHECK: %[[INSERT_1_ID:[a-zA-Z0-9_]*]] = OpCompositeInsert %[[FLOAT2_TYPE_ID]] %[[A_1_LOAD_ID]] %[[INSERT_0_ID]] 1
// CHECK: %[[BITCAST_ID:[a-zA-Z0-9_]*]] = OpBitcast %[[UINT2_TYPE_ID]] %[[INSERT_1_ID]]
