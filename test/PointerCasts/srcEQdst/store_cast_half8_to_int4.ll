...
; CHECK: [[ld:%[^ ]+]] = load <4 x i32>, <4 x i32> addrspace(1)* %b
...
entry:
  %0 = load <4 x i32>, <4 x i32> addrspace(1)* %b, align 8
  %1 = bitcast [8 x half] addrspace(1)* %a to <4 x i32> addrspace(1)*
  %arrayidx = getelementptr inbounds <4 x i32>, <4 x i32> addrspace(1)* %1, i32 %i
  store <4 x i32> %0, <4 x i32> addrspace(1)* %arrayidx, align 8
  ret void
}
