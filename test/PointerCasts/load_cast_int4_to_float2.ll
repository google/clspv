...
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr <4 x i32>, <4 x i32> addrspace(1)* %b, i32 [[shr]]
; CHECK: [[ld0:%[a-zA-Z0-9_.]+]] = load <4 x i32>, <4 x i32> addrspace(1)* [[gep]]
; CHECK: [[and:%[a-zA-Z0-9_.]+]] = and i32 %i, 1
; CHECK: [[shl:%[a-zA-Z0-9_.]+]] = shl i32 [[and]], 1
; CHECK: [[ex0:%[a-zA-Z0-9_.]+]] = extractelement <4 x i32> [[ld0]], i32 [[shl]]
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <2 x i32> undef, i32 [[ex0]], i32 0
; CHECK: [[add:%[a-zA-Z0-9_.]+]] = add i32 [[shl]], 1
; CHECK: [[ex1:%[a-zA-Z0-9_.]+]] = extractelement <4 x i32> [[ld0]], i32 [[add]]
; CHECK: [[in1:%[a-zA-Z0-9_.]+]] = insertelement <2 x i32> [[in0]], i32 [[ex1]], i32 1
; CHECK: bitcast <2 x i32> [[in1]] to <2 x float>
define spir_kernel void @foo(<2 x float> addrspace(1)* %a, <4 x i32> addrspace(1)* %b, i32 %i) {
entry:
  %0 = bitcast <4 x i32> addrspace(1)* %b to <2 x float> addrspace(1)*
