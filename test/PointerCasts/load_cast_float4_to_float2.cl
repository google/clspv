...
// CHECK: %[[A_ACCESS_CHAIN_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT2_GLOBAL_POINTER_TYPE_ID]] %[[ARG0_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_0_ID]]
...
// CHECK: %[[B_INDEX_ID:[a-zA-Z0-9_]*]] = OpShiftRightLogical %[[UINT_TYPE_ID]] %[[I_LOAD_ID]] %[[CONSTANT_1_ID]]
...
// CHECK: %[[B_SUB_INDEX_ID:[a-zA-Z0-9_]*]] = OpBitwiseAnd %[[UINT_TYPE_ID]] %[[I_LOAD_ID]] %[[CONSTANT_1_ID]]
// CHECK: %[[B_SUB_0_INDEX_ID:[a-zA-Z0-9_]*]] = OpShiftLeftLogical %[[UINT_TYPE_ID]] %[[B_SUB_INDEX_ID]] %[[CONSTANT_1_ID]]
...
// CHECK: %[[B_SUB_1_INDEX_ID:[a-zA-Z0-9_]*]] = OpIAdd %[[UINT_TYPE_ID]] %[[B_SUB_0_INDEX_ID]] %[[CONSTANT_1_ID]]
...
// CHECK: OpStore %[[A_ACCESS_CHAIN_ID]] %[[INSERT_ELEMENT_1_ID]]
