// RUN: clspv %target %s -o %t.spv -cluster-pod-kernel-args -arch=spirv32 --spv-version=1.4
// RUN: spirv-dis -o %t2.spvasm %t.spv
// RUN: FileCheck %s < %t2.spvasm --check-prefixes=CHECK,CHECK-32
// RUN: spirv-val --target-env vulkan1.2 %t.spv

// RUN: clspv %target %s -o %t.spv -cluster-pod-kernel-args -arch=spirv64 --spv-version=1.4
// RUN: spirv-dis -o %t2.spvasm %t.spv
