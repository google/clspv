...
// CHECK: OpMemberDecorate %[[FLOAT4_ARG_STRUCT_TYPE_ID:[a-zA-Z0-9_]*]] 0 Offset 0
// CHECK: OpDecorate %[[FLOAT4_ARG_STRUCT_TYPE_ID]] BufferBlock
...
// CHECK: %[[FLOAT4_UNIFORM_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT4_TYPE_ID]]
// CHECK: %[[FLOAT4_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[FLOAT4_TYPE_ID]]
// CHECK: %[[FLOAT4_ARG_STRUCT_TYPE_ID]] = OpTypeStruct %[[FLOAT4_DYNAMIC_ARRAY_TYPE_ID]]
// CHECK: %[[FLOAT4_ARG_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT4_ARG_STRUCT_TYPE_ID]]
...
// CHECK: %[[ARG1_ID]] = OpVariable %[[FLOAT4_ARG_POINTER_TYPE_ID]] StorageBuffer
...
// CHECK: %[[B_ACCESS_CHAIN0_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT4_UNIFORM_POINTER_TYPE_ID]] %[[ARG1_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_0_ID]]
// CHECK: %[[LOADB0_ID:[a-zA-Z0-9_]*]] = OpLoad %[[FLOAT4_TYPE_ID]] %[[B_ACCESS_CHAIN0_ID]]
// CHECK: %[[B_ACCESS_CHAIN1_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT4_UNIFORM_POINTER_TYPE_ID]] %[[ARG1_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_1_ID]]
// CHECK: %[[LOADB1_ID:[a-zA-Z0-9_]*]] = OpLoad %[[FLOAT4_TYPE_ID]] %[[B_ACCESS_CHAIN1_ID]]
