...
// CHECK: %[[B_ACCESS_CHAIN0_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT_UNIFORM_POINTER_TYPE_ID]] %[[ARG1_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_0_ID]]
// CHECK: %[[LOADB0_ID:[a-zA-Z0-9_]*]] = OpLoad %[[FLOAT_TYPE_ID]] %[[B_ACCESS_CHAIN0_ID]]
// CHECK: %[[B_ACCESS_CHAIN1_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[FLOAT_UNIFORM_POINTER_TYPE_ID]] %[[ARG1_ID]] %[[CONSTANT_0_ID]] %[[CONSTANT_1_ID]]
