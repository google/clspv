...
// CHECK: OpDecorate %[[FLOAT3_ARG_STRUCT_TYPE_ID]] BufferBlock
...
// CHECK: %[[FLOAT3_UNIFORM_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT3_TYPE_ID]]
// CHECK: %[[FLOAT3_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[FLOAT3_TYPE_ID]]
// CHECK: %[[FLOAT3_ARG_STRUCT_TYPE_ID]] = OpTypeStruct %[[FLOAT3_DYNAMIC_ARRAY_TYPE_ID]]
// CHECK: %[[FLOAT3_ARG_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT3_ARG_STRUCT_TYPE_ID]]
