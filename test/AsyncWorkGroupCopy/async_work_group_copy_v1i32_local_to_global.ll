...
entry:
  %call = call spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS1iPU3AS3Kcj9ocl_event(i32 addrspace(1)* %dst, i32 addrspace(3)* %src, i32 %num_gentypes, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS1iPU3AS3Kcj9ocl_event(i32 addrspace(1)*, i32 addrspace(3)*, i32, %opencl.event_t*)
