...
define dso_local spir_func %opencl.event_t* @foo(i32 addrspace(1)* %dst, i32 addrspace(3)* %src, i32 %num_gentypes, %opencl.event_t* %event) {
entry:
  %call = call spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS1iPU3AS3Kij9ocl_event(i32 addrspace(1)* %dst, i32 addrspace(3)* %src, i32 %num_gentypes, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS1iPU3AS3Kij9ocl_event(i32 addrspace(1)*, i32 addrspace(3)*, i32, %opencl.event_t*)
...
; CHECK: [[loop]]:
; CHECK: [[dsti:%[a-zA-Z0-9_.]+]] = getelementptr i32, i32 addrspace(1)* %dst, i32 [[phiiterator]]
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr i32, i32 addrspace(3)* %src, i32 [[phiiterator]]
; CHECK: [[nextiterator]] = add i32 [[phiiterator]], [[incr]]
; CHECK: call void @_Z8spirv.op.63.PU3AS1jPU3AS3j(i32 63, i32 addrspace(1)* [[dsti]], i32 addrspace(3)* [[srci]])
; CHECK: br label %[[cmp]]
