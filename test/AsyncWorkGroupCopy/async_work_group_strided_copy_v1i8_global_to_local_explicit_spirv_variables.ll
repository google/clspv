...
define dso_local spir_func %opencl.event_t* @foo(i8 addrspace(3)* %dst, i8 addrspace(1)* %src, i32 %num_gentypes, i32 %stride, %opencl.event_t* %event) {
entry:
  %call = call spir_func %opencl.event_t* @_Z29async_work_group_strided_copyPU3AS3cPU3AS1Kcjj9ocl_event(i8 addrspace(3)* %dst, i8 addrspace(1)* %src, i32 %num_gentypes, i32 %stride, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z29async_work_group_strided_copyPU3AS3cPU3AS1Kcjj9ocl_event(i8 addrspace(3)*, i8 addrspace(1)*, i32, i32, %opencl.event_t*)
...
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr i8, i8 addrspace(1)* %src, i32 [[srciterator]]
