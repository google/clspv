...
entry:
  %call = call spir_func ptr @_Z21async_work_group_copyPU3AS1lPU3AS3Klj9ocl_event(ptr addrspace(1) %dst, ptr addrspace(3) %src, i32 %num_gentypes, ptr %event)
  ret ptr %call
}

declare spir_func ptr @_Z21async_work_group_copyPU3AS1lPU3AS3Klj9ocl_event(ptr addrspace(1), ptr addrspace(3), i32, ptr)
...
; CHECK: [[loop]]:
; CHECK: [[dsti:%[a-zA-Z0-9_.]+]] = getelementptr i64, ptr addrspace(1) %dst, i32 [[phiiterator]]
