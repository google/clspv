...
entry:
  %call = call spir_func ptr @_Z21async_work_group_copyPU3AS3lPU3AS1Klj9ocl_event(ptr addrspace(3) %dst, ptr addrspace(1) %src, i32 %num_gentypes, ptr %event)
  ret ptr %call
}

declare spir_func ptr @_Z21async_work_group_copyPU3AS3lPU3AS1Klj9ocl_event(ptr addrspace(3), ptr addrspace(1), i32, ptr)
...
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr i64, ptr addrspace(1) %src, i32 [[phiiterator]]
