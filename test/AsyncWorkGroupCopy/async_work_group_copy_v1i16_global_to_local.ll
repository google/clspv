...
entry:
  %call = call spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS3sPU3AS1Kcj9ocl_event(i16 addrspace(3)* %dst, i16 addrspace(1)* %src, i32 %num_gentypes, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS3sPU3AS1Kcj9ocl_event(i16 addrspace(3)*, i16 addrspace(1)*, i32, %opencl.event_t*)
