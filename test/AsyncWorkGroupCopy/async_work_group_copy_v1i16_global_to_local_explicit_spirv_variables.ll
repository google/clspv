...
define dso_local spir_func %opencl.event_t* @foo(i16 addrspace(3)* %dst, i16 addrspace(1)* %src, i32 %num_gentypes, %opencl.event_t* %event) {
entry:
  %call = call spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS3sPU3AS1Ksj9ocl_event(i16 addrspace(3)* %dst, i16 addrspace(1)* %src, i32 %num_gentypes, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS3sPU3AS1Ksj9ocl_event(i16 addrspace(3)*, i16 addrspace(1)*, i32, %opencl.event_t*)
...
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr i16, i16 addrspace(1)* %src, i32 [[phiiterator]]
; CHECK: [[nextiterator]] = add i32 [[phiiterator]], [[incr]]
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i16, i16 addrspace(1)* [[srci]]
; CHECK: store i16 [[ld]], i16 addrspace(3)* [[dsti]]
; CHECK: br label %[[cmp]]
