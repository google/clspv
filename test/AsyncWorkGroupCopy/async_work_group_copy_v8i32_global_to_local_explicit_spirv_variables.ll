...
entry:
  %call = call spir_func ptr @_Z21async_work_group_copyPU3AS3Dv8_iPU3AS1KS_j9ocl_event(ptr addrspace(3) %dst, ptr addrspace(1) %src, i32 %num_gentypes, ptr %event)
  ret ptr %call
}
...
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr [8 x i32], ptr addrspace(1) %src, i32 [[phiiterator]]
