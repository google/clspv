...
define dso_local spir_func %opencl.event_t* @foo(<8 x i32> addrspace(3)* %dst, <8 x i32> addrspace(1)* %src, i32 %num_gentypes, %opencl.event_t* %event) {
entry:
  %call = call spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS3Dv8_iPU3AS1KS_j9ocl_event(<8 x i32> addrspace(3)* %dst, <8 x i32> addrspace(1)* %src, i32 %num_gentypes, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS3Dv8_iPU3AS1KS_j9ocl_event(<8 x i32> addrspace(3)*, <8 x i32> addrspace(1)*, i32, %opencl.event_t*)
