...
define dso_local spir_func %opencl.event_t* @foo(<8 x i16> addrspace(1)* %dst, <8 x i16> addrspace(3)* %src, i32 %num_gentypes, %opencl.event_t* %event) {
entry:
  %call = call spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS1Dv8_sPU3AS3KS_j9ocl_event(<8 x i16> addrspace(1)* %dst, <8 x i16> addrspace(3)* %src, i32 %num_gentypes, %opencl.event_t* %event)
  ret %opencl.event_t* %call
}

declare spir_func %opencl.event_t* @_Z21async_work_group_copyPU3AS1Dv8_sPU3AS3KS_j9ocl_event(<8 x i16> addrspace(1)*, <8 x i16> addrspace(3)*, i32, %opencl.event_t*)
