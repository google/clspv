...
entry:
  %call = call spir_func ptr @_Z29async_work_group_strided_copyPU3AS3Dv8_sPU3AS1KS_jj9ocl_event(ptr addrspace(3) %dst, ptr addrspace(1) %src, i32 %num_gentypes, i32 %stride, ptr %event)
  ret ptr %call
}

declare spir_func ptr @_Z29async_work_group_strided_copyPU3AS3Dv8_sPU3AS1KS_jj9ocl_event(ptr addrspace(3), ptr addrspace(1), i32, i32, ptr)
...
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr [8 x i16], ptr addrspace(1) %src, i32 [[srciterator]]
