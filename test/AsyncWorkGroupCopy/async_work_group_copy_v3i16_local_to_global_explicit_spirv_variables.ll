...
entry:
  %call = call spir_func ptr @_Z21async_work_group_copyPU3AS1Dv3_sPU3AS3KS_j9ocl_event(ptr addrspace(1) %dst, ptr addrspace(3) %src, i32 %num_gentypes, ptr %event)
  ret ptr %call
}

declare spir_func ptr @_Z21async_work_group_copyPU3AS1Dv3_sPU3AS3KS_j9ocl_event(ptr addrspace(1), ptr addrspace(3), i32, ptr)
...
; CHECK: [[loop]]:
; CHECK: [[dsti:%[a-zA-Z0-9_.]+]] = getelementptr <3 x i16>, ptr addrspace(1) %dst, i32 [[phiiterator]]
