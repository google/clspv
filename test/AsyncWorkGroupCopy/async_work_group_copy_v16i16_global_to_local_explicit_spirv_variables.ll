...
entry:
  %call = call spir_func ptr @_Z21async_work_group_copyPU3AS3Dv16_sPU3AS1KS_j9ocl_event(ptr addrspace(3) %dst, ptr addrspace(1) %src, i32 %num_gentypes, ptr %event)
  ret ptr %call
}

declare spir_func ptr @_Z21async_work_group_copyPU3AS3Dv16_sPU3AS1KS_j9ocl_event(ptr addrspace(3), ptr addrspace(1), i32, ptr)
...
; CHECK: [[srci:%[a-zA-Z0-9_.]+]] = getelementptr [16 x i16], ptr addrspace(1) %src, i32 [[phiiterator]]
