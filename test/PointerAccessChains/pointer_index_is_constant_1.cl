...
// CHECK-DAG: %[[_arr_float_uint_128:[0-9a-zA-Z_]+]] = OpTypeArray %[[float]]
// CHECK-DAG: %[[_struct_9:[0-9a-zA-Z_]+]] = OpTypeStruct %[[_arr_float_uint_128]]
// CHECK-DAG: %[[_runtimearr__struct_9:[0-9a-zA-Z_]+]] = OpTypeRuntimeArray %[[_struct_9]]
// CHECK-DAG: %[[_struct_11:[0-9a-zA-Z_]+]] = OpTypeStruct %[[_runtimearr__struct_9]]
// CHECK-DAG: %[[_ptr_StorageBuffer__struct_11:[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer %[[_struct_11]]
...
// CHECK-DAG: %[[_6:[0-9]+]] = OpVariable %[[_ptr_StorageBuffer__struct_11]] StorageBuffer
...
// CHECK:     %[[_20:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_float]] %[[_6]] %[[uint_0]] %[[uint_1]] %[[uint_0]] %[[uint_5]]
...
// NODRA-DAG: %[[_arr_float_uint_128:[0-9a-zA-Z_]+]] = OpTypeArray %[[float]]
// NODRA-DAG: %[[_struct_9:[0-9a-zA-Z_]+]] = OpTypeStruct %[[_arr_float_uint_128]]
// NODRA-DAG: %[[_runtimearr__struct_9:[0-9a-zA-Z_]+]] = OpTypeRuntimeArray %[[_struct_9]]
// NODRA-DAG: %[[_struct_11:[0-9a-zA-Z_]+]] = OpTypeStruct %[[_runtimearr__struct_9]]
// NODRA-DAG: %[[_ptr_StorageBuffer__struct_11:[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer %[[_struct_11]]
// NODRA-DAG: %[[_ptr_StorageBuffer__struct_9:[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer %[[_struct_9]]
...
// NODRA-DAG: %[[uint_5:[0-9a-zA-Z_]+]] = OpConstant %[[uint]] 5
// NODRA-DAG: %[[_5:[0-9]+]] = OpVariable %[[_ptr_StorageBuffer__struct_3]] StorageBuffer
// NODRA-DAG: %[[_6:[0-9]+]] = OpVariable %[[_ptr_StorageBuffer__struct_11]] StorageBuffer
// NODRA:     %[[_9:[0-9]+]] = OpFunction %[[float]]
// NODRA:     %[[_10:[0-9]+]] = OpFunctionParameter %[[_ptr_StorageBuffer__struct_9]]
// NODRA:     %[[_11:[0-9]+]] = OpLabel
// NODRA:     %[[_14:[0-9]+]] = OpPtrAccessChain %[[_ptr_StorageBuffer_float]] %[[_10]] %[[uint_1]] %[[uint_0]] %[[uint_5]]
...
// NODRA:     %[[_22:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer__struct_9]] %[[_6]] %[[uint_0]] %[[uint_0]]
