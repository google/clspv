...
// CHECK-DAG:  [[_arr_float_128:%[0-9a-zA-Z_]+]] = OpTypeArray [[_float]]
// CHECK-DAG:  [[__struct_9:%[0-9a-zA-Z_]+]] = OpTypeStruct [[_arr_float_128]]
// CHECK-DAG:  [[__runtimearr__struct_9:%[0-9a-zA-Z_]+]] = OpTypeRuntimeArray [[__struct_9]]
// CHECK-DAG:  [[__struct_11:%[0-9a-zA-Z_]+]] = OpTypeStruct [[__runtimearr__struct_9]]
...
// CHECK-DAG:  [[_18:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_StorageBuffer__struct_10]] StorageBuffer
// CHECK-DAG:  [[_19:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_StorageBuffer__struct_11]] StorageBuffer
// CHECK:  [[_21:%[0-9a-zA-Z_]+]] = OpFunction
// CHECK:  [[param:%[a-zA-Z0-9_]+]] = OpFunctionParameter [[__ptr_StorageBuffer__struct_9]]
...
// CHECK:  [[_28:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_float]] [[_18]] [[_uint_0]] [[_uint_0]]
// CHECK:  [[_29:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer__struct_9]] [[_19]] [[_uint_0]] [[_uint_0]]
