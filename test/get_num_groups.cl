...
// CHECK: OpDecorate %[[BUILTIN_ID]] BuiltIn NumWorkgroups
...
// CHECK: %[[GET_NUM_GROUPS_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeFunction %[[UINT_TYPE_ID]] %[[UINT_TYPE_ID]]
...
// CHECK: %[[RESULT_ID:[a-zA-Z0-9_]*]] = OpFunctionCall %[[UINT_TYPE_ID]] %[[GET_NUM_GROUPS_ID:[a-zA-Z0-9_]*]] %[[LOAD1_ID]]
...
// CHECK: %[[GET_NUM_GROUPS_ID]] = OpFunction %[[UINT_TYPE_ID]] Const %[[GET_NUM_GROUPS_TYPE_ID]]
...
// CHECK: %[[SELECT2_ID:[a-zA-Z0-9_]*]] = OpSelect %[[UINT_TYPE_ID]] %[[COND_ID]] %[[LOAD2_ID]] %[[CONSTANT_1_ID]]
