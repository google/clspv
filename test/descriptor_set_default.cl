...
// MAP-NEXT: kernel,foo,arg,n,argOrdinal,1,descriptorSet,1,binding,0,offset,0
// MAP-NEXT: kernel,foo,arg,c,argOrdinal,2,descriptorSet,1,binding,0,offset,16

// MAP-NEXT: kernel,bar,arg,B,argOrdinal,0,descriptorSet,0,binding,0,offset,0
// MAP-NEXT: kernel,bar,arg,m,argOrdinal,1,descriptorSet,2,binding,0,offset,0
// MAP-NOT: kernel
...
// CHECK:  OpDecorate [[_21:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CHECK:  OpDecorate [[_21]] Binding 0
// CHECK:  OpDecorate [[_22:%[0-9a-zA-Z_]+]] DescriptorSet 2
