...
// CHECK: define dso_local spir_kernel void @foo(double addrspace(1)* %out, i32 %in) #0 !kernel_arg_addr_space !3 !kernel_arg_access_qual !4 !kernel_arg_type !5 !kernel_arg_base_type !5 !kernel_arg_type_qual !6 {
// CHECK: entry:
