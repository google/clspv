; RUN: clspv-opt %s -o %t.ll -ReplaceLLVMIntrinsics
...
entry:
  %dst = alloca [7 x float]
  %src_cast = bitcast float addrspace(1)* %A to i8 addrspace(1)*
  %dst_cast = bitcast [7 x float]* %dst to i8*
  call void @llvm.memcpy.p0i8.p1i8.i64(i8* %dst_cast, i8 addrspace(1)* %src_cast, i64 28, i1 false)
  ret void
}
...
; CHECK: call void @_Z17spirv.copy_memory(float* [[dst_gep]], float addrspace(1)* [[src_gep]], i32 0, i32 0)
