...
define spir_kernel void @smin_i16(i16 addrspace(1)* %out, i16 %a, i16 %b) {
entry:
...
define spir_kernel void @smin_i32(i32 addrspace(1)* %out, i32 %a, i32 %b) {
entry:
...
define spir_kernel void @smin_i64(i64 addrspace(1)* %out, i64 %a, i64 %b) {
entry:
