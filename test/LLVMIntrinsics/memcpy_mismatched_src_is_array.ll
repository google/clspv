...
entry:
  ...
  call void @llvm.memcpy.p1i8.p0i8.i64(i8 addrspace(1)* %dst_cast, i8* %src_cast, i64 28, i1 false)
  ret void
}
...
; CHECK: call void @_Z17spirv.copy_memory(float addrspace(1)* [[dst_gep]], float* [[src_gep]], i32 0, i32 0)
