...
// CHECK: %[[GET_GLOBAL_ID_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeFunction %[[UINT_TYPE_ID]] %[[UINT_TYPE_ID]]
...
// CHECK: %[[RESULT_ID:[a-zA-Z0-9_]*]] = OpFunctionCall %[[UINT_TYPE_ID]] %[[GET_GLOBAL_ID_ID:[a-zA-Z0-9_]*]] %[[LOAD1_ID]]
...
// CHECK: %[[GET_GLOBAL_ID_ID]] = OpFunction %[[UINT_TYPE_ID]] Const %[[GET_GLOBAL_ID_TYPE_ID]]
...
// CHECK: %[[ACCESS_CHAIN3_ID:[a-zA-Z0-9_]*]] = OpAccessChain %[[UINT_INPUT_POINTER_TYPE_ID]] %[[GLOBAL_ID_VAR_ID]] %[[SELECT1_ID]]
