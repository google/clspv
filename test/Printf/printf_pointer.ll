...
; CHECK: [[ptrtoint:%[^ ]+]] = ptrtoint ptr addrspace(1) [[ptr]] to i32
; CHECK: store i32 [[ptrtoint]]

target datalayout = "e-p:32:32-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "spirv32-unknown-vulkan"

@.str = private unnamed_addr addrspace(2) constant [3 x i8] c"%p\00", align 1
@__spirv_WorkgroupSize = addrspace(8) global <3 x i32> zeroinitializer

; Function Attrs: convergent norecurse nounwind
define dso_local spir_kernel void @test(ptr addrspace(1) align 4 %a) #0 !kernel_arg_addr_space !7 !kernel_arg_access_qual !8 !kernel_arg_type !9 !kernel_arg_base_type !9 !kernel_arg_type_qual !10 !clspv.pod_args_impl !11 {
entry:
  %a.addr = alloca ptr addrspace(1), align 4
  store ptr addrspace(1) null, ptr %a.addr, align 4
...
declare spir_func i32 @printf(ptr addrspace(2), ...) #1
