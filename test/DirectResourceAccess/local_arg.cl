...
// CHECK-DAG:  [[__struct_13]] = OpTypeStruct [[__runtimearr_uint]]
// CHECK-DAG:  [[__ptr_StorageBuffer__struct_13:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__struct_13]]
// CHECK-DAG:  [[__struct_15]] = OpTypeStruct [[_uint]]
...
// CHECK-DAG:      [[_33]] = OpVariable [[__ptr_StorageBuffer__struct_13]] StorageBuffer
// CHECK-DAG:      [[_34]] = OpVariable [[__ptr_StorageBuffer__struct_15]] StorageBuffer
...
// CHECK:      [[_41:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Workgroup_uint]] [[_1]] [[_40]]
...
// CHECK:      [[_n45:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Workgroup_uint]] [[_1]] [[_uint_0]]
// CHECK:      [[_50:%[0-9a-zA-Z_]+]] = OpIAdd [[_uint]] [[_47]] [[_uint_1]]
// CHECK:      [[_51:%[0-9a-zA-Z_]+]] = OpFunctionCall [[_void]] [[_35]] [[_49]] [[_50]] [[_n45]]
// CHECK:      OpReturn
// CHECK:      OpFunctionEnd
...
// CHECK:      [[_10:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Workgroup_uint]] [[_1]] [[_uint_0]]
