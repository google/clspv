...
// CHECK-DAG:  [[_gl_WorkGroupSize]] = OpSpecConstantComposite [[_v3uint]] [[_15]] [[_16]] [[_17]]
// CHECK-DAG:  [[_19:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_Private_v3uint]] Private [[_gl_WorkGroupSize]]
// CHECK-DAG:  [[_20]] = OpVariable [[__ptr_StorageBuffer__struct_3]] StorageBuffer
// CHECK-DAG:  [[_21]] = OpVariable [[__ptr_StorageBuffer__struct_3]] StorageBuffer
// CHECK-DAG:  [[_22]] = OpVariable [[__ptr_StorageBuffer__struct_5]] StorageBuffer
// CHECK-DAG:  [[_23]] = OpVariable [[__ptr_StorageBuffer__struct_5]] StorageBuffer
// CHECK-DAG:  [[_24]] = OpVariable [[__ptr_StorageBuffer__struct_3]] StorageBuffer
