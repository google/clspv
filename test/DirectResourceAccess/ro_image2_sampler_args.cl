...
// CHECK-DAG:  [[__struct_11]] = OpTypeStruct [[_v2float]]
// CHECK-DAG:  [[__ptr_StorageBuffer__struct_11:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__struct_11]]
// CHECK-DAG:  [[_18:%[0-9a-zA-Z_]+]] = OpTypeFunction [[_v4float]] [[_4]] [[_v2float]] [[_2]]
...
// CHECK-DAG:  [[_14:%[0-9a-zA-Z_]+]] = OpTypeFunction [[_void]]
// CHECK-DAG:  [[_v3uint:%[0-9a-zA-Z_]+]] = OpTypeVector [[_uint]] 3
// CHECK-DAG:  [[__ptr_Private_v3uint:%[0-9a-zA-Z_]+]] = OpTypePointer Private [[_v3uint]]
// CHECK-DAG:  [[_22:%[0-9a-zA-Z_]+]] = OpTypeSampledImage [[_4]]
// CHECK-DAG:  [[_uint_0:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 0
// CHECK-DAG:  [[_float_2:%[0-9a-zA-Z_]+]] = OpConstant [[_float]] 2
// CHECK-DAG:  [[_25:%[0-9a-zA-Z_]+]] = OpConstantComposite [[_v2float]] [[_float_2]] [[_float_2]]
// CHECK-DAG:  [[_float_3:%[0-9a-zA-Z_]+]] = OpConstant [[_float]] 3
// CHECK-DAG:  [[_27:%[0-9a-zA-Z_]+]] = OpConstantComposite [[_v2float]] [[_float_3]] [[_float_3]]
...
// CHECK-DAG:  [[_31]] = OpSpecConstant [[_uint]] 1
// CHECK-DAG:  [[_gl_WorkGroupSize]] = OpSpecConstantComposite [[_v3uint]] [[_29]] [[_30]] [[_31]]
// CHECK-DAG:  [[_33:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_Private_v3uint]] Private [[_gl_WorkGroupSize]]
// CHECK-DAG:  [[_34]] = OpVariable [[__ptr_UniformConstant_2]] UniformConstant
// CHECK-DAG:  [[_35]] = OpVariable [[__ptr_UniformConstant_4]] UniformConstant
// CHECK-DAG:  [[_36]] = OpVariable [[__ptr_StorageBuffer__struct_8]] StorageBuffer
// CHECK-DAG:  [[_37]] = OpVariable [[__ptr_StorageBuffer__struct_11]] StorageBuffer
