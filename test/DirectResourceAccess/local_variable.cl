...
// CHECK-DAG: [[_uint_32:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 32
// CHECK-DAG: [[__arr_uint_uint_32]] = OpTypeArray [[_uint]] [[_uint_32]]
// CHECK-DAG: [[__ptr_Workgroup__arr_uint_uint_32:%[0-9a-zA-Z_]+]] = OpTypePointer Workgroup [[__arr_uint_uint_32]]
...
// CHECK-DAG: [[_21:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_Workgroup__arr_uint_uint_32]] Workgroup
// CHECK-DAG: [[_gl_GlobalInvocationID:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_Input_v3uint]] Input
...
// CHECK-DAG: [[_28]] = OpVariable [[__ptr_StorageBuffer__struct_3]] StorageBuffer
// CHECK-DAG: [[_29]] = OpVariable [[__ptr_StorageBuffer__struct_3]] StorageBuffer
