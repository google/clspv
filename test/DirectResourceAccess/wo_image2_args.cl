...
// CHECK-DAG:  [[__struct_6]] = OpTypeStruct [[_v2uint]]
...
// CHECK-DAG:  [[_21:%[0-9a-zA-Z_]+]] = OpConstantComposite [[_v2uint]] [[_uint_1]] [[_uint_1]]
// CHECK-DAG:  [[_uint_3:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 3
// CHECK-DAG:  [[_23:%[0-9a-zA-Z_]+]] = OpConstantComposite [[_v2uint]] [[_uint_3]] [[_uint_3]]
