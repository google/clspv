...
// CHECK: %[[LOAD_ID:[a-zA-Z0-9_]*]] = OpLoad %[[UINT_TYPE_ID]] %[[LOADA_ACCESS_CHAIN_ID]]
// CHECK: %[[OP_ID:[a-zA-Z0-9_]*]] = OpConvertSToF %[[FLOAT_TYPE_ID]] %[[LOAD_ID]]
// CHECK: OpStore %[[LOADB_ACCESS_CHAIN_ID]] %[[OP_ID]]
  *b = (float)*a;
// CHECK: OpReturn
}
// CHECK: OpFunctionEnd
