...
// CHECK: OpDecorate %[[FLOAT_ARG1_STRUCT_TYPE_ID]] BufferBlock
...
// CHECK: %[[FLOAT_ARG1_STRUCT_TYPE_ID]] = OpTypeStruct %[[FLOAT_DYNAMIC_ARRAY_TYPE_ID]]
// CHECK: %[[FLOAT_ARG1_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT_ARG1_STRUCT_TYPE_ID]]
...
// CHECK: %[[UINT_CONSTANT_42_ID:[a-zA-Z0-9_]*]] = OpConstant %[[UINT_TYPE_ID]] 42
// CHECK: %[[FLOAT_CONSTANT_42_ID:[a-zA-Z0-9_]*]] = OpConstant %[[FLOAT_TYPE_ID]] 42
