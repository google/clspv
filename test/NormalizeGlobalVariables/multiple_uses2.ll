...
; CHECK-NOT: internal addrspace(2) constant { <{ <{ [9 x i32], [8 x i32] }>, [17 x i32], [17 x i32], [17 x i32] }>, [4 x [17 x i32]] }
; CHECK: internal addrspace(2) constant { [4 x [17 x i32]] }
...
entry:
  ...
  %gep2 = getelementptr inbounds [4 x [17 x i32]], ptr addrspace(2) @data, i32 0, i32 0, i32 1
  ret void
}
