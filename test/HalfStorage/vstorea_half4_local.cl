...
// CHECK: [[__ptr_Workgroup_v2uint:%[0-9a-zA-Z_]+]] = OpTypePointer Workgroup [[_v2uint]]
// CHECK: [[_v3uint:%[0-9a-zA-Z_]+]] = OpTypeVector [[_uint]] 3
// CHECK: [[__ptr_Private_v3uint:%[0-9a-zA-Z_]+]] = OpTypePointer Private [[_v3uint]]
// CHECK: [[_2]] = OpSpecConstant [[_uint]] 1
// CHECK: [[__arr_v2uint_2:%[0-9a-zA-Z_]+]] = OpTypeArray [[_v2uint]] [[_2]]
// CHECK: [[__ptr_Workgroup__arr_v2uint_2:%[0-9a-zA-Z_]+]] = OpTypePointer Workgroup [[__arr_v2uint_2]]
