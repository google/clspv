...
entry:
  %0 = call spir_func <3 x float> @_Z12vloada_half3jPU3AS1KDh(i32 %b, ptr addrspace(1) %a)
  ret <3 x float> %0
}

declare spir_func <3 x float> @_Z12vloada_half3jPU3AS1KDh(i32, ptr addrspace(1))
