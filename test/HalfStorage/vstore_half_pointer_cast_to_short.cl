...
// CHECK: %[[SHORT_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeInt 16 0
// CHECK: %[[SHORT_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[SHORT_TYPE_ID]]
// CHECK: %[[SHORT_DYNAMIC_ARRAY_TYPE_ID]] = OpTypeRuntimeArray %[[SHORT_TYPE_ID]]
// CHECK: %[[ARG0_STRUCT_TYPE_ID]] = OpTypeStruct %[[SHORT_DYNAMIC_ARRAY_TYPE_ID]]
