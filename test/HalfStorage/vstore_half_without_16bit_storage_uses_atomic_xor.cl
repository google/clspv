// RUN: clspv %target %s -o %t.spv -no-16bit-storage=ssbo -arch=spir
// RUN: spirv-dis -o %t2.spvasm %t.spv
// RUN: FileCheck %s < %t2.spvasm --check-prefixes=CHECK,CHECK-32
// RUN: spirv-val --target-env vulkan1.0 %t.spv

// RUN: clspv %target %s -o %t.spv -no-16bit-storage=ssbo -arch=spir64
// RUN: spirv-dis -o %t2.spvasm %t.spv
...
// CHECK-64: %[[N_LONG:[a-zA-Z0-9_]*]] = OpSConvert %[[ULONG_TYPE_ID]] %[[N]]
...
// CHECK-64: %[[INDEX_INTO_UINT:[a-zA-Z0-9_]*]] = OpShiftRightLogical %[[ULONG_TYPE_ID]] %[[N_LONG]] %[[CONSTANT_1_LONG_ID]]
// CHECK-32: %[[INDEX_INTO_UINT:[a-zA-Z0-9_]*]] = OpShiftRightLogical %[[UINT_TYPE_ID]] %[[N]] %[[CONSTANT_1_ID]]
