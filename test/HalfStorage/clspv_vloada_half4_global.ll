...
define void @foo(<4 x float> addrspace(1)* %a, ptr addrspace(1) %b, i32 %n) {
entry:
  ...
  %call1 = call spir_func <4 x float> @_Z20__clspv_vloada_half4jPU3AS1KDv2_j(i32 %n, ptr addrspace(1) %cast)
  ...
  ; CHECK: [[unpack1:%[a-zA-Z0-9_.]+]] = call <2 x float> @_Z18spirv.unpack.v2f16(i32 [[ex1]])
  ; CHECK: shufflevector <2 x float> [[unpack0]], <2 x float> [[unpack1]], <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %call2 = call spir_func <4 x float> @_Z20__clspv_vloada_half4jPU3AS1KDv2_j(i32 0, ptr addrspace(1) %cast)
  ret void
}
