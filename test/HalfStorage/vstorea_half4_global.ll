...
entry:
  ...
  call spir_func void @_Z14vstorea_half_4Dv4_fjPU3AS1Dh(<4 x float> %b, i32 %n, ptr addrspace(1) %add.ptr)
  ret void
}

declare spir_func void @_Z14vstorea_half_4Dv4_fjPU3AS1Dh(<4 x float>, i32, ptr addrspace(1))
