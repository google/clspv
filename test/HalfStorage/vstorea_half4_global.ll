...
define void @foo(<2 x i32> addrspace(1)* %a, <4 x float> %b, i32 %n) {
entry:
  %cast = bitcast <2 x i32> addrspace(1)* %a to half addrspace(1)*
  ...
  call spir_func void @_Z13vstorea_half4Dv4_fjPU3AS1Dh(<4 x float> %b, i32 %n, half addrspace(1)* %add.ptr)
  ...
  ; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr <2 x i32>, <2 x i32> addrspace(1)* [[cast]], i32 %add
  ; CHECK: store <2 x i32> [[in1]], <2 x i32> addrspace(1)* [[gep]]
  call spir_func void @_Z17vstorea_half4_rteDv4_fjPU3AS1Dh(<4 x float> %b, i32 %add, half addrspace(1)* %add.ptr1)
  ...
  ; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr <2 x i32>, <2 x i32> addrspace(1)* [[cast]], i32 %add2
  ; CHECK: store <2 x i32> [[in1]], <2 x i32> addrspace(1)* [[gep]]
  call spir_func void @_Z17vstorea_half4_rteDv4_fjPU3AS1Dh(<4 x float> %b, i32 %add2, half addrspace(1)* %add.ptr2)
  ret void
}

declare spir_func void @_Z13vstorea_half4Dv4_fjPU3AS1Dh(<4 x float>, i32, half addrspace(1)*)
declare spir_func void @_Z17vstorea_half4_rteDv4_fjPU3AS1Dh(<4 x float>, i32, half addrspace(1)*)
declare spir_func void @_Z17vstorea_half4_rtzDv4_fjPU3AS1Dh(<4 x float>, i32, half addrspace(1)*)
