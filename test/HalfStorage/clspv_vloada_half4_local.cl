...
// CHECK: [[__ptr_Workgroup_v4float:%[0-9a-zA-Z_]+]] = OpTypePointer Workgroup [[_v4float]]
...
// CHECK: [[__arr_v4float_2:%[0-9a-zA-Z_]+]] = OpTypeArray [[_v4float]] [[_2]]
// CHECK: [[__ptr_Workgroup__arr_v4float_2:%[0-9a-zA-Z_]+]] = OpTypePointer Workgroup [[__arr_v4float_2]]
