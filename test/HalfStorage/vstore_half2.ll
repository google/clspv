...
entry:
  call spir_func void @_Z12vstore_half2Dv2_fjPU3AS1Dh(<2 x float> %b, i32 %c, ptr addrspace(1) %a)
  ret void
}

declare spir_func void @_Z12vstore_half2Dv2_fjPU3AS1Dh(<2 x float>, i32, ptr addrspace(1))
