...
// CHECK: [[__struct_6]] = OpTypeStruct [[__runtimearr_v2uint]]
...
// CHECK: [[_uint_64:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 64
// CHECK: [[__arr_v2uint_uint_64]] = OpTypeArray [[_v2uint]] [[_uint_64]]
// CHECK: [[__ptr_Function__arr_v2uint_uint_64:%[0-9a-zA-Z_]+]] = OpTypePointer Function [[__arr_v2uint_uint_64]]
// CHECK: [[__ptr_Function_v2uint:%[0-9a-zA-Z_]+]] = OpTypePointer Function [[_v2uint]]
...
// CHECK: [[_27:%[0-9a-zA-Z_]+]] = OpConstantNull [[__arr_v2uint_uint_64]]
