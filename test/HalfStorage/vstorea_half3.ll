...
entry:
  call spir_func void @_Z13vstorea_half3Dv3_fjPU3AS1Dh(<3 x float> %b, i32 %c, ptr addrspace(1) %a)
  ret void
}

declare spir_func void @_Z13vstorea_half3Dv3_fjPU3AS1Dh(<3 x float>, i32, ptr addrspace(1))
...
; CHECK:  [[gep0:%[^ ]+]] = getelementptr i16, ptr addrspace(1) %a, i32 [[cx4]]
