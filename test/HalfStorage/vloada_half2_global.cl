...
// CHECK: [[__struct_11]] = OpTypeStruct [[__runtimearr_uint]]
...
// CHECK: [[_16:%[0-9a-zA-Z_]+]] = OpTypeFunction [[_void]]
...
// CHECK: [[_32:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_28]] [[_uint_0]]
// CHECK: [[_33:%[0-9a-zA-Z_]+]] = OpLoad [[_uint]] [[_32]]
// CHECK: [[_34:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_27]] [[_uint_0]] [[_33]]
// CHECK: [[_35:%[0-9a-zA-Z_]+]] = OpLoad [[_uint]] [[_34]]
// CHECK: [[_36:%[0-9a-zA-Z_]+]] = OpExtInst [[_v2float]] [[_1]] UnpackHalf2x16 [[_35]]
// CHECK: OpStore [[_31]] [[_36]]
// CHECK: [[_37:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_StorageBuffer_uint]] [[_27]] [[_uint_0]] [[_uint_1]]
