...
; CHECK: [[gep:%[0-9]+]] = getelementptr <3 x i32>, <3 x i32> addrspace(8)* @__spirv_WorkgroupSize, i32 0, i32 [[sel]]
; CHECK: [[ld1:%[0-9]+]] = load i32, i32 addrspace(8)* [[gep]]
; CHECK: [[gep:%[0-9]+]] = getelementptr <3 x i32>, <3 x i32> addrspace(5)* @__spirv_NumWorkgroups, i32 0, i32 [[sel]]
; CHECK: [[ld2:%[0-9]+]] = load i32, i32 addrspace(5)* [[gep]]
