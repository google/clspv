...
; CHECK: [[gep:%[0-9]+]] = getelementptr <3 x i32>, <3 x i32> addrspace(5)* @__spirv_LocalInvocationId, i32 0, i32 [[sel]]
; CHECK: [[ld:%[0-9]+]] = load i32, i32 addrspace(5)* [[gep]]
...
define dso_local spir_kernel void @foo(i32 addrspace(1)* align 4 %a, i32 %b) #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 !reqd_work_group_size !8 !clspv.pod_args_impl !9 {
entry:
