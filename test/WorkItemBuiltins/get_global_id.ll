...
; CHECK: define spir_func i32 @_Z13get_global_idj(i32 [[p:%[0-9]+]])
; CHECK: [[cmp:%[0-9]+]] = icmp ult i32 [[p]], 3
; CHECK: [[sel:%[0-9]+]] = select i1 [[cmp]], i32 [[p]], i32 0
; CHECK: [[gep:%[0-9]+]] = getelementptr <3 x i32>, <3 x i32> addrspace(5)* @__spirv_GlobalInvocationId, i32 0, i32 [[sel]]
...
entry:
  ...
  %call = call spir_func i32 @_Z13get_global_idj(i32 3) #2
