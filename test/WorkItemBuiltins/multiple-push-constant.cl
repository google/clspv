...
// DMAP: pushconstant,name,dimensions,offset,16,size,4
...
// CHECK-DAG: %[[_struct_10]] = OpTypeStruct %[[v3uint]] %[[uint]]
...
// CHECK:     %[[__original_id_20:[0-9]+]] = OpAccessChain %[[_ptr_PushConstant_uint]] %[[__original_id_15]] %[[uint_1]]
