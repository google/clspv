...
; CHECK: [[gep:%[0-9]+]] = getelementptr inbounds <3 x i32>, <3 x i32> addrspace(5)* @__spirv_NumWorkgroups, i32 0, i32 [[sel]]
...
entry:
  ...
  %call = call spir_func i32 @_Z14get_num_groupsj(i32 3) #2
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %a.addr, align 4
  %1 = load i32, i32* %b.addr, align 4
  %call1 = call spir_func i32 @_Z14get_num_groupsj(i32 %1) #2
