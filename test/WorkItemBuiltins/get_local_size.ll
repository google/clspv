...
; CHECK: call spir_func i32 @_Z14get_local_sizej(i32 3)
; CHECK: call spir_func i32 @_Z14get_local_sizej(i32 %b)
...
; CHECK: [[ld:%[0-9]+]] = load <3 x i32>, <3 x i32> addrspace(8)* @__spirv_WorkgroupSize
...
define dso_local spir_kernel void @foo(i32 addrspace(1)* align 4 %a, i32 %b) #0 !reqd_work_group_size !8 !clspv.pod_args_impl !9 {
entry:
  %a.addr = alloca i32 addrspace(1)*, align 4
  store i32 addrspace(1)* null, i32 addrspace(1)** %a.addr, align 4
  %b.addr = alloca i32, align 4
  store i32 0, i32* %b.addr, align 4
  store i32 addrspace(1)* %a, i32 addrspace(1)** %a.addr, align 4
  store i32 %b, i32* %b.addr, align 4
  %call = call spir_func i32 @_Z14get_local_sizej(i32 3) #2
  %0 = load i32 addrspace(1)*, i32 addrspace(1)** %a.addr, align 4
  %1 = load i32, i32* %b.addr, align 4
  %call1 = call spir_func i32 @_Z14get_local_sizej(i32 %1) #2
  %arrayidx = getelementptr inbounds i32, i32 addrspace(1)* %0, i32 %call1
  store i32 %call, i32 addrspace(1)* %arrayidx, align 4
  ret void
}

declare spir_func i32 @_Z14get_local_sizej(i32) #1
