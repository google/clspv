...
// CHECK: OpDecorate %[[BUILTIN_ID]] BuiltIn WorkgroupId
...
// CHECK: %[[GET_GROUP_ID_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypeFunction %[[UINT_TYPE_ID]] %[[UINT_TYPE_ID]]
...
// CHECK: %[[RESULT_ID:[a-zA-Z0-9_]*]] = OpFunctionCall %[[UINT_TYPE_ID]] %[[GET_GROUP_ID_ID:[a-zA-Z0-9_]*]] %[[LOAD1_ID]]
...
// CHECK: %[[GET_GROUP_ID_ID]] = OpFunction %[[UINT_TYPE_ID]] Const %[[GET_GROUP_ID_TYPE_ID]]
