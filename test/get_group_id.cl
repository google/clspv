...
// CHECK:  OpDecorate [[_gl_WorkGroupID]] BuiltIn WorkgroupId
...
// CHECK:  [[_gl_WorkGroupID]] = OpVariable [[__ptr_Input_v3uint]] Input
...
// CHECK:  [[_31:%[0-9a-zA-Z_]+]] = OpAccessChain [[__ptr_Input_uint]] [[_gl_WorkGroupID]] [[_30]]
