...
; CHECK: OpCopyMemorySized [[out]] [[in]] [[uint_64]] Volatile|Aligned 8
; CHECK: [[ld:%[a-zA-Z0-9_]+]] = OpLoad
; CHECK: OpCopyMemorySized [[out]] [[in]] [[ld]] Aligned 16
...
entry:
  ...
  tail call void @llvm.memcpy.p1.p1.i32(ptr addrspace(1) noundef align 8 dereferenceable(16) %2, ptr addrspace(1) noundef align 32 dereferenceable(16) %1, i32 64, i1 true)
  %ld = load i32, ptr addrspace(1) %1, align 4
  tail call void @llvm.memcpy.p1.p1.i32(ptr addrspace(1) noundef align 64 dereferenceable(16) %2, ptr addrspace(1) noundef align 16 dereferenceable(16) %1, i32 %ld, i1 false)
  ret void
}
