...
; CHECK-DAG: OpDecorate [[ptr:%[a-zA-Z0-9_]+]] ArrayStride 272
...
entry:
  ...
  %7 = getelementptr inbounds %struct.TestStruct, ptr addrspace(1) %4, i64 %idxprom.i.i, i32 0, i32 0, i32 1
  store float 0x47EFFFFFE0000000, ptr addrspace(1) %7, align 4
  ret void
}
