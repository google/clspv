...
// CHECK: %[[CONSTANT_NEG_1_ID:[a-zA-Z0-9_]*]] = OpConstant %[[UINT_TYPE_ID]] 4294967295
...
// CHECK: %[[OP_ID:[a-zA-Z0-9_]*]] = OpBitwiseXor %[[UINT_TYPE_ID]] %[[LOADB_ID]] %[[CONSTANT_NEG_1_ID:[a-zA-Z0-9_]*]]
