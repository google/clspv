...
entry:
  ...
  %2 = getelementptr { [1024 x %struct.S] }, ptr addrspace(2) %1, i32 0, i32 0, i32 0, i32 3
  %3 = load <4 x i32>, ptr addrspace(2) %2, align 16
  %4 = getelementptr { [0 x %struct.S] }, ptr addrspace(1) %0, i32 0, i32 0, i32 0, i32 3
