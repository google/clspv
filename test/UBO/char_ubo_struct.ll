...
%struct.S = type { i8, <2 x i8>, <3 x i8>, <4 x i8>, i32 }
...
entry:
  ...
  %1 = call ptr addrspace(2) @_Z14clspv.resource.1(i32 0, i32 1, i32 1, i32 1, i32 1, i32 0, { [4096 x %struct.S] } zeroinitializer)
  %5 = getelementptr { [4096 x %struct.S] }, ptr addrspace(2) %1, i32 0, i32 0, i32 0, i32 3
...
declare ptr addrspace(2) @_Z14clspv.resource.1(i32, i32, i32, i32, i32, i32, { [4096 x %struct.S] })
