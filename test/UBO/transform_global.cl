...
//  CHECK-32: [[add:%[a-zA-Z0-9_]+]] = OpIAdd [[int]] [[n_load]] [[zero]]
//  CHECK-64: [[n_load_long:%[0-9a-zA-Z_]+]] = OpSConvert [[long]] [[n_load]]
//  CHECK-64: [[add:%[a-zA-Z0-9_]+]] = OpIAdd [[long]] [[n_load_long]]
//  CHECK-64: [[c_arg_gep:%[0-9a-zA-Z_]+]] = OpAccessChain [[c_arg_ele_ptr]] [[c_arg]] [[zero]] [[add]] [[zero]]
//  CHECK-32: [[c_arg_gep:%[0-9a-zA-Z_]+]] = OpAccessChain [[c_arg_ele_ptr]] [[c_arg]] [[zero]] [[add]] [[zero]]
//     CHECK: [[c_load:%[0-9a-zA-Z_]+]] = OpLoad [[int]] [[c_arg_gep]]
//  CHECK-32: [[add:%[a-zA-Z0-9_]+]] = OpIAdd [[int]] [[n_load]] [[zero]]
//  CHECK-64: [[add:%[a-zA-Z0-9_]+]] = OpIAdd [[long]] [[n_load_long]]
//  CHECK-64: [[priv_gep:%[0-9a-zA-Z_]+]] = OpAccessChain [[c_var_ele_ptr]] [[c_var]] [[add]] [[zero]]
//  CHECK-32: [[priv_gep:%[0-9a-zA-Z_]+]] = OpAccessChain [[c_var_ele_ptr]] [[c_var]] [[add]] [[zero]]
//     CHECK: [[priv_load:%[0-9a-zA-Z_]+]] = OpLoad [[int]] [[priv_gep]]
//     CHECK: [[res:%[0-9a-zA-Z_]+]] = OpIAdd [[int]] [[priv_load]] [[c_load]]
//  CHECK-32: [[add:%[a-zA-Z0-9_]+]] = OpIAdd [[int]] [[n_load]] [[zero]]
//  CHECK-64: [[add:%[a-zA-Z0-9_]+]] = OpIAdd [[long]] [[n_load_long]]
//  CHECK-64: [[data_gep:%[0-9a-zA-Z_]+]] = OpAccessChain [[data_ele_ptr]] [[data]] [[zero]] [[add]] [[zero]]
//  CHECK-32: [[data_gep:%[0-9a-zA-Z_]+]] = OpAccessChain [[data_ele_ptr]] [[data]] [[zero]] [[add]] [[zero]]
