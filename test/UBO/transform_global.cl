// RUN: clspv -constant-args-ubo -inline-entry-points %s -o %t.spv -int8=0 -pod-ubo -arch=spir
...
// RUN: clspv -constant-args-ubo -inline-entry-points %s -o %t.spv -int8=0 -pod-ubo -arch=spir64
// RUN: spirv-dis -o %t2.spvasm %t.spv
