...
// CHECK-DAG: [[__arr_uint_uint_2]] = OpTypeArray [[_uint]] [[_uint_2]]
// CHECK-DAG: [[__struct_4]] = OpTypeStruct [[__arr_uint_uint_2]]
// CHECK-DAG: [[__struct_5]] = OpTypeStruct [[__struct_4]] [[_uint]] [[__struct_4]]
...
// CHECK-DAG: [[_12:%[0-9a-zA-Z_]+]] = OpTypeFunction [[_void]]
// CHECK-DAG: [[__ptr_StorageBuffer_uint:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[_uint]]
// CHECK-DAG: [[_14:%[0-9a-zA-Z_]+]] = OpTypeFunction [[__struct_5]] [[_uint]]
...
// CHECK-DAG: [[_uint_10:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 10
// CHECK-DAG: [[_23:%[0-9a-zA-Z_]+]] = OpUndef [[__arr_uint_uint_2]]
// CHECK-DAG: [[_24:%[0-9a-zA-Z_]+]] = OpUndef [[_uint]]
// CHECK-DAG: [[_false:%[0-9a-zA-Z_]+]] = OpConstantFalse [[_bool]]
// CHECK-DAG: [[_true:%[0-9a-zA-Z_]+]] = OpConstantTrue [[_bool]]
// CHECK-DAG: [[_uint_4294967291:%[0-9a-zA-Z_]+]] = OpConstant [[_uint]] 4294967291
// CHECK-DAG: [[_28]] = OpSpecConstant [[_uint]] 1
// CHECK-DAG: [[_29]] = OpSpecConstant [[_uint]] 1
// CHECK-DAG: [[_30]] = OpSpecConstant [[_uint]] 1
// CHECK-DAG: [[_gl_WorkGroupSize]] = OpSpecConstantComposite [[_v3uint]] [[_28]] [[_29]] [[_30]]
// CHECK-DAG: [[_32:%[0-9a-zA-Z_]+]] = OpVariable [[__ptr_Private_v3uint]] Private [[_gl_WorkGroupSize]]
// CHECK-DAG: [[_33]] = OpVariable [[__ptr_StorageBuffer__struct_7]] StorageBuffer
// CHECK-DAG: [[_34]] = OpVariable [[__ptr_StorageBuffer__struct_9]] StorageBuffer
