...
entry:
  ...
  %call = call spir_func float @_Z8lgamma_rfPU3AS1i(float %0, ptr addrspace(1) %a2)
  %arrayidx1 = getelementptr inbounds <2 x float>, ptr addrspace(1) %b, i32 0
  %1 = load <2 x float>, ptr addrspace(1) %arrayidx1, align 8
  %call2 = call spir_func <2 x float> @_Z8lgamma_rDv2_fPU3AS1Dv2_i(<2 x float> %1, ptr addrspace(1) %b2)
  %arrayidx3 = getelementptr inbounds <3 x float>, ptr addrspace(1) %c, i32 0
  %2 = load <3 x float>, ptr addrspace(1) %arrayidx3, align 16
  %call4 = call spir_func <3 x float> @_Z8lgamma_rDv3_fPU3AS1Dv3_i(<3 x float> %2, ptr addrspace(1) %c2)
  %arrayidx5 = getelementptr inbounds <4 x float>, ptr addrspace(1) %d, i32 0
  %3 = load <4 x float>, ptr addrspace(1) %arrayidx5, align 16
  %call6 = call spir_func <4 x float> @_Z8lgamma_rDv4_fPU3AS1Dv4_i(<4 x float> %3, ptr addrspace(1) %d2)
  %arrayidx7 = getelementptr inbounds <8 x float>, ptr addrspace(1) %e, i32 0
  %4 = load <8 x float>, ptr addrspace(1) %arrayidx7, align 32
  %call8 = call spir_func <8 x float> @_Z8lgamma_rDv8_fPU3AS1Dv8_i(<8 x float> %4, ptr addrspace(1) %e2)
  %arrayidx9 = getelementptr inbounds <16 x float>, ptr addrspace(1) %f, i32 0
  %5 = load <16 x float>, ptr addrspace(1) %arrayidx9, align 64
  %call10 = call spir_func <16 x float> @_Z8lgamma_rDv16_fPU3AS1Dv16_i(<16 x float> %5, ptr addrspace(1) %f2)
  ret void
}

declare spir_func float @_Z8lgamma_rfPU3AS1i(float, ptr addrspace(1))
declare spir_func <2 x float> @_Z8lgamma_rDv2_fPU3AS1Dv2_i(<2 x float>, ptr addrspace(1))
declare spir_func <3 x float> @_Z8lgamma_rDv3_fPU3AS1Dv3_i(<3 x float>, ptr addrspace(1))
declare spir_func <4 x float> @_Z8lgamma_rDv4_fPU3AS1Dv4_i(<4 x float>, ptr addrspace(1))
declare spir_func <8 x float> @_Z8lgamma_rDv8_fPU3AS1Dv8_i(<8 x float>, ptr addrspace(1))
declare spir_func <16 x float> @_Z8lgamma_rDv16_fPU3AS1Dv16_i(<16 x float>, ptr addrspace(1))
