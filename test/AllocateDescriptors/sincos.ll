...
entry:
  ...
  %call = call spir_func float @_Z6sincosfPU3AS1f(float %0, ptr addrspace(1) %arrayidx1)
  ...
  %call4 = call spir_func <2 x float> @_Z6sincosDv2_fPU3AS1S_(<2 x float> %1, ptr addrspace(1) %arrayidx3)
  ...
  %call7 = call spir_func <3 x float> @_Z6sincosDv3_fPU3AS1S_(<3 x float> %2, ptr addrspace(1) %arrayidx6)
  ...
  %call10 = call spir_func <4 x float> @_Z6sincosDv4_fPU3AS1S_(<4 x float> %3, ptr addrspace(1) %arrayidx9)
  ...
  %call13 = call spir_func <8 x float> @_Z6sincosDv8_fPU3AS1S_(<8 x float> %4, ptr addrspace(1) %arrayidx12)
  ...
  %call16 = call spir_func <16 x float> @_Z6sincosDv16_fPU3AS1S_(<16 x float> %5, ptr addrspace(1) %arrayidx15)
  ret void
}

declare spir_func float @_Z6sincosfPU3AS1f(float, ptr addrspace(1))
declare spir_func <2 x float> @_Z6sincosDv2_fPU3AS1S_(<2 x float>, ptr addrspace(1))
declare spir_func <3 x float> @_Z6sincosDv3_fPU3AS1S_(<3 x float>, ptr addrspace(1))
declare spir_func <4 x float> @_Z6sincosDv4_fPU3AS1S_(<4 x float>, ptr addrspace(1))
declare spir_func <8 x float> @_Z6sincosDv8_fPU3AS1S_(<8 x float>, ptr addrspace(1))
declare spir_func <16 x float> @_Z6sincosDv16_fPU3AS1S_(<16 x float>, ptr addrspace(1))
