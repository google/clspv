...
// CHECK-DAG: %[[FLOAT_STRUCT_TYPE_ID]] = OpTypeStruct %[[FLOAT_TYPE_ID]]
// CHECK-DAG: %[[FLOAT_STRUCT_POINTER_TYPE_ID:[a-zA-Z0-9_]*]] = OpTypePointer StorageBuffer %[[FLOAT_STRUCT_TYPE_ID]]
