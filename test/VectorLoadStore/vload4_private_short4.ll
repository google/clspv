...
define void @foo(i16 addrspace(0)* %in, i32 %offset) {
entry:
  %0 = call spir_func <4 x i16> @_Z6vload4Dv4_jPU3AS0t(i32 %offset, i16 addrspace(0)* %in)
  ret void
}

declare <4 x i16> @_Z6vload4Dv4_jPU3AS0t(i32, i16 addrspace(0)*)
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i16, i16* [[gep]]
