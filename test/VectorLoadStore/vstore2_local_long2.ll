...
define void @foo(i64 addrspace(3)* %in, <2 x i64> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_mjPU3AS3m(<2 x i64> %data, i32 %offset, i64 addrspace(3)* %in)
  ret void
}

declare void @_Z7vstore2Dv2_mjPU3AS3m(<2 x i64>, i32, i64 addrspace(3)*)
