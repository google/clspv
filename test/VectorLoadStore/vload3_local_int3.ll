...
entry:
  %0 = call spir_func <3 x i32> @_Z6vload3Dv3_jPU3AS3j(i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare <3 x i32> @_Z6vload3Dv3_jPU3AS3j(i32, ptr addrspace(3))
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i32, ptr addrspace(3) [[gep]]
