...
entry:
  %0 = call spir_func <4 x i8> @_Z6vload4Dv4_jPU3AS1h(i32 %offset, ptr addrspace(1) %in)
  ret void
}

declare <4 x i8> @_Z6vload4Dv4_jPU3AS1h(i32, ptr addrspace(1))
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i8, ptr addrspace(1) [[gep]]
