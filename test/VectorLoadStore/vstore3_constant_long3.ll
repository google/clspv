...
define void @foo(i64 addrspace(2)* %in, <3 x i64> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_mjPU3AS2m(<3 x i64> %data, i32 %offset, i64 addrspace(2)* %in)
  ret void
}

declare void @_Z7vstore3Dv3_mjPU3AS2m(<3 x i64>, i32, i64 addrspace(2)*)
