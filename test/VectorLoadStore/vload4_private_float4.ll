...
entry:
  %0 = call spir_func <4 x float> @_Z6vload4Dv4_jPU3AS0f(i32 %offset, ptr addrspace(0) %in)
  ret void
}

declare <4 x float> @_Z6vload4Dv4_jPU3AS0f(i32, ptr addrspace(0))
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load float, ptr [[gep]]
