...
define void @foo(ptr addrspace(3) %in, <3 x float> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_fjPU3AS3f(<3 x float> %data, i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare void @_Z7vstore3Dv3_fjPU3AS3f(<3 x float>, i32, ptr addrspace(3))
