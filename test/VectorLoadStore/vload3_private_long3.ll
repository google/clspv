...
entry:
  %0 = call spir_func <3 x i64> @_Z6vload3Dv3_jPU3AS0m(i32 %offset, ptr addrspace(0) %in)
  ret void
}

declare <3 x i64> @_Z6vload3Dv3_jPU3AS0m(i32, ptr addrspace(0))
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i64, ptr [[gep]]
