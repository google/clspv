...
entry:
  %0 = call spir_func <3 x i64> @_Z6vload3Dv3_jPU3AS2m(i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare <3 x i64> @_Z6vload3Dv3_jPU3AS2m(i32, ptr addrspace(2))
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i64, ptr addrspace(2) [[gep]]
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <3 x i64> poison, i64 [[ld]], i64 0
