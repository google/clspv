...
define void @foo(ptr addrspace(3) %in, <4 x i32> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore4Dv4_jjPU3AS3j(<4 x i32> %data, i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare void @_Z7vstore4Dv4_jjPU3AS3j(<4 x i32>, i32, ptr addrspace(3))
