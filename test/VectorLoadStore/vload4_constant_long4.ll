...
entry:
  %0 = call spir_func <4 x i64> @_Z6vload4Dv4_jPU3AS2m(i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare <4 x i64> @_Z6vload4Dv4_jPU3AS2m(i32, ptr addrspace(2))
...
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <4 x i64> poison, i64 [[ld]], i64 0
