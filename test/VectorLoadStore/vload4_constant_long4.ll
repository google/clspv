...
define void @foo(i64 addrspace(2)* %in, i32 %offset) {
entry:
  %0 = call spir_func <4 x i64> @_Z6vload4Dv4_jPU3AS2m(i32 %offset, i64 addrspace(2)* %in)
  ret void
}

declare <4 x i64> @_Z6vload4Dv4_jPU3AS2m(i32, i64 addrspace(2)*)
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i64, i64 addrspace(2)* [[gep]]
