...
define void @foo(double addrspace(1)* %in, <3 x double> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_djPU3AS1d(<3 x double> %data, i32 %offset, double addrspace(1)* %in)
  ret void
}

declare void @_Z7vstore3Dv3_djPU3AS1d(<3 x double>, i32, double addrspace(1)*)
