...
define void @foo(half addrspace(3)* %in, <2 x half> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_kDhjPU3AS3kDh(<2 x half> %data, i32 %offset, half addrspace(3)* %in)
  ret void
}

declare void @_Z7vstore2Dv2_kDhjPU3AS3kDh(<2 x half>, i32, half addrspace(3)*)
