...
define void @foo(ptr addrspace(3) %in, <2 x i8> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_hjPU3AS3h(<2 x i8> %data, i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare void @_Z7vstore2Dv2_hjPU3AS3h(<2 x i8>, i32, ptr addrspace(3))
