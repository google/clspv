...
define void @foo(double addrspace(3)* %in, i32 %offset) {
entry:
  %0 = call spir_func <2 x double> @_Z6vload2Dv2_jPU3AS3d(i32 %offset, double addrspace(3)* %in)
  ret void
}

declare <2 x double> @_Z6vload2Dv2_jPU3AS3d(i32, double addrspace(3)*)
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load double, double addrspace(3)* [[gep]]
