...
define void @foo(ptr addrspace(1) %in, <3 x i64> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_mjPU3AS1m(<3 x i64> %data, i32 %offset, ptr addrspace(1) %in)
  ret void
}

declare void @_Z7vstore3Dv3_mjPU3AS1m(<3 x i64>, i32, ptr addrspace(1))
