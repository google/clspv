...
define void @foo(half addrspace(3)* %in, <3 x half> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_kDhjPU3AS3kDh(<3 x half> %data, i32 %offset, half addrspace(3)* %in)
  ret void
}

declare void @_Z7vstore3Dv3_kDhjPU3AS3kDh(<3 x half>, i32, half addrspace(3)*)
