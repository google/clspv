...
define void @foo(ptr addrspace(0) %in, <3 x double> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_djPU3AS0d(<3 x double> %data, i32 %offset, ptr addrspace(0) %in)
  ret void
}

declare void @_Z7vstore3Dv3_djPU3AS0d(<3 x double>, i32, ptr addrspace(0))
