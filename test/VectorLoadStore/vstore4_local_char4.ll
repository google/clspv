...
define void @foo(ptr addrspace(3) %in, <4 x i8> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore4Dv4_hjPU3AS3h(<4 x i8> %data, i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare void @_Z7vstore4Dv4_hjPU3AS3h(<4 x i8>, i32, ptr addrspace(3))
