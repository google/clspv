...
define void @foo(i8 addrspace(1)* %in, <4 x i8> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore4Dv4_hjPU3AS1h(<4 x i8> %data, i32 %offset, i8 addrspace(1)* %in)
  ret void
}

declare void @_Z7vstore4Dv4_hjPU3AS1h(<4 x i8>, i32, i8 addrspace(1)*)
