...
define void @foo(ptr addrspace(3) %in, <3 x i16> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_tjPU3AS3t(<3 x i16> %data, i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare void @_Z7vstore3Dv3_tjPU3AS3t(<3 x i16>, i32, ptr addrspace(3))
