...
define void @foo(double addrspace(3)* %in, <4 x double> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore4Dv4_djPU3AS3d(<4 x double> %data, i32 %offset, double addrspace(3)* %in)
  ret void
}

declare void @_Z7vstore4Dv4_djPU3AS3d(<4 x double>, i32, double addrspace(3)*)
