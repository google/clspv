...
define void @foo(i8 addrspace(2)* %in, i32 %offset) {
entry:
  %0 = call spir_func <3 x i8> @_Z6vload3Dv3_jPU3AS2h(i32 %offset, i8 addrspace(2)* %in)
  ret void
}

declare <3 x i8> @_Z6vload3Dv3_jPU3AS2h(i32, i8 addrspace(2)*)
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i8, i8 addrspace(2)* [[gep]]
