...
define void @foo(ptr addrspace(0) %in, <2 x float> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_fjPU3AS0f(<2 x float> %data, i32 %offset, ptr addrspace(0) %in)
  ret void
}

declare void @_Z7vstore2Dv2_fjPU3AS0f(<2 x float>, i32, ptr addrspace(0))
