...
define void @foo(i16 addrspace(1)* %in, <3 x i16> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_tjPU3AS1t(<3 x i16> %data, i32 %offset, i16 addrspace(1)* %in)
  ret void
}

declare void @_Z7vstore3Dv3_tjPU3AS1t(<3 x i16>, i32, i16 addrspace(1)*)
