...
entry:
  %0 = call spir_func <4 x float> @_Z6vload4Dv4_jPU3AS3f(i32 %offset, ptr addrspace(3) %in)
  ret void
}

declare <4 x float> @_Z6vload4Dv4_jPU3AS3f(i32, ptr addrspace(3))
...
; CHECK: [[gep:%[a-zA-Z0-9_.]+]] = getelementptr float, ptr addrspace(3) %in, i32 [[add]]
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load float, ptr addrspace(3) [[gep]]
;i16* CHECK: [[in3:%[a-zA-Z0-9_.]+]] = insertelement <4 x float> [[in2]], float [[ld]], i64 3
