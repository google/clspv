...
define void @foo(float addrspace(3)* %in, i32 %offset) {
entry:
  %0 = call spir_func <4 x float> @_Z6vload4Dv4_jPU3AS3f(i32 %offset, float addrspace(3)* %in)
  ret void
}

declare <4 x float> @_Z6vload4Dv4_jPU3AS3f(i32, float addrspace(3)*)
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load float, float addrspace(3)* [[gep]]
