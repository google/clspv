...
define void @foo(i32 addrspace(3)* %in, i32 %offset) {
entry:
  %0 = call spir_func <4 x i32> @_Z6vload4Dv4_jPU3AS3j(i32 %offset, i32 addrspace(3)* %in)
  ret void
}

declare <4 x i32> @_Z6vload4Dv4_jPU3AS3j(i32, i32 addrspace(3)*)
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i32, i32 addrspace(3)* [[gep]]
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <4 x i32> undef, i32 [[ld]], i64 0
