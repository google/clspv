...
entry:
  %0 = call spir_func <4 x float> @_Z6vload4Dv4_jPU3AS2f(i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare <4 x float> @_Z6vload4Dv4_jPU3AS2f(i32, ptr addrspace(2))
...
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <4 x float> poison, float [[ld]], i64 0
