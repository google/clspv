...
define void @foo(ptr addrspace(2) %in, <3 x float> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_fjPU3AS2f(<3 x float> %data, i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare void @_Z7vstore3Dv3_fjPU3AS2f(<3 x float>, i32, ptr addrspace(2))
