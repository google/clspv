...
define void @foo(float addrspace(2)* %in, <3 x float> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_fjPU3AS2f(<3 x float> %data, i32 %offset, float addrspace(2)* %in)
  ret void
}

declare void @_Z7vstore3Dv3_fjPU3AS2f(<3 x float>, i32, float addrspace(2)*)
