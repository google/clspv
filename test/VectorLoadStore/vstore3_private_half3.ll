...
define void @foo(ptr addrspace(0) %in, <3 x half> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_kDhjPU3AS0kDh(<3 x half> %data, i32 %offset, ptr addrspace(0) %in)
  ret void
}

declare void @_Z7vstore3Dv3_kDhjPU3AS0kDh(<3 x half>, i32, ptr addrspace(0))
