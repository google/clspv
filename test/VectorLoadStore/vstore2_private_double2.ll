...
define void @foo(double addrspace(0)* %in, <2 x double> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_djPU3AS0d(<2 x double> %data, i32 %offset, double addrspace(0)* %in)
  ret void
}

declare void @_Z7vstore2Dv2_djPU3AS0d(<2 x double>, i32, double addrspace(0)*)
...
; CHECK: store double [[ex]], double* [[gep]]
