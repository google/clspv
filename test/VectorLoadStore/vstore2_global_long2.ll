...
define void @foo(ptr addrspace(1) %in, <2 x i64> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_mjPU3AS1m(<2 x i64> %data, i32 %offset, ptr addrspace(1) %in)
  ret void
}

declare void @_Z7vstore2Dv2_mjPU3AS1m(<2 x i64>, i32, ptr addrspace(1))
