...
entry:
  %0 = call spir_func <4 x i16> @_Z6vload4Dv4_jPU3AS2t(i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare <4 x i16> @_Z6vload4Dv4_jPU3AS2t(i32, ptr addrspace(2))
...
; CHECK: [[ld:%[a-zA-Z0-9_.]+]] = load i16, ptr addrspace(2) [[gep]]
; CHECK: [[in0:%[a-zA-Z0-9_.]+]] = insertelement <4 x i16> poison, i16 [[ld]], i64 0
