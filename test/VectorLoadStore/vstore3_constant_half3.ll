...
define void @foo(ptr addrspace(2) %in, <3 x half> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore3Dv3_kDhjPU3AS2kDh(<3 x half> %data, i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare void @_Z7vstore3Dv3_kDhjPU3AS2kDh(<3 x half>, i32, ptr addrspace(2))
