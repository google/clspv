...
define void @foo(ptr addrspace(2) %in, <2 x double> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_djPU3AS2d(<2 x double> %data, i32 %offset, ptr addrspace(2) %in)
  ret void
}

declare void @_Z7vstore2Dv2_djPU3AS2d(<2 x double>, i32, ptr addrspace(2))
