...
define void @foo(i8 addrspace(0)* %in, <2 x i8> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_hjPU3AS0h(<2 x i8> %data, i32 %offset, i8 addrspace(0)* %in)
  ret void
}

declare void @_Z7vstore2Dv2_hjPU3AS0h(<2 x i8>, i32, i8 addrspace(0)*)
