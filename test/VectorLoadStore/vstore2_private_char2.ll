...
define void @foo(ptr addrspace(0) %in, <2 x i8> %data, i32 %offset) {
entry:
  call spir_func void @_Z7vstore2Dv2_hjPU3AS0h(<2 x i8> %data, i32 %offset, ptr addrspace(0) %in)
  ret void
}

declare void @_Z7vstore2Dv2_hjPU3AS0h(<2 x i8>, i32, ptr addrspace(0))
