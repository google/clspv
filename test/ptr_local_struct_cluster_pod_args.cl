...
// CHECK-DAG:  [[__struct_15]] = OpTypeStruct [[_float]] [[_float]]
// CHECK-DAG:  [[__struct_16]] = OpTypeStruct [[__struct_15]]
// CHECK-DAG:  [[__ptr_StorageBuffer__struct_16:%[0-9a-zA-Z_]+]] = OpTypePointer StorageBuffer [[__struct_16]]
// CHECK-DAG:  [[_uint:%[0-9a-zA-Z_]+]] = OpTypeInt 32 0
// CHECK-DAG:  [[_void:%[0-9a-zA-Z_]+]] = OpTypeVoid
// CHECK-DAG:  [[_20:%[0-9a-zA-Z_]+]] = OpTypeFunction [[_void]]
...
// CHECK-DAG:  [[__struct_24]] = OpTypeStruct [[_uint]] [[_uint]]
