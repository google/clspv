...
define spir_kernel void @test(<8 x i32> %srcA, <8 x i32> %srcB, ptr addrspace(1) noundef align 32 %dst, <8 x i32> %mask) {
entry:
...
; CHECK: [[srcAGepi2:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcA_alloca]], i32 0, i32 [[mask2mod]]
; CHECK: [[srcA2:%[^ ]+]] = load i32, ptr [[srcAGepi2]], align 4
; CHECK: [[srcBGepi2:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcB_alloca]], i32 0, i32 [[mask2mod]]
; CHECK: [[srcB2:%[^ ]+]] = load i32, ptr [[srcBGepi2]], align 4
...
; CHECK: [[srcAGepi3:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcA_alloca]], i32 0, i32 [[mask3mod]]
; CHECK: [[srcA3:%[^ ]+]] = load i32, ptr [[srcAGepi3]], align 4
; CHECK: [[srcBGepi3:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcB_alloca]], i32 0, i32 [[mask3mod]]
; CHECK: [[srcB3:%[^ ]+]] = load i32, ptr [[srcBGepi3]], align 4
...
; CHECK: [[srcAGepi4:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcA_alloca]], i32 0, i32 [[mask4mod]]
; CHECK: [[srcA4:%[^ ]+]] = load i32, ptr [[srcAGepi4]], align 4
; CHECK: [[srcBGepi4:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcB_alloca]], i32 0, i32 [[mask4mod]]
; CHECK: [[srcB4:%[^ ]+]] = load i32, ptr [[srcBGepi4]], align 4
...
; CHECK: [[srcAGepi5:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcA_alloca]], i32 0, i32 [[mask5mod]]
; CHECK: [[srcA5:%[^ ]+]] = load i32, ptr [[srcAGepi5]], align 4
; CHECK: [[srcBGepi5:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcB_alloca]], i32 0, i32 [[mask5mod]]
; CHECK: [[srcB5:%[^ ]+]] = load i32, ptr [[srcBGepi5]], align 4
...
; CHECK: [[srcAGepi6:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcA_alloca]], i32 0, i32 [[mask6mod]]
; CHECK: [[srcA6:%[^ ]+]] = load i32, ptr [[srcAGepi6]], align 4
; CHECK: [[srcBGepi6:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcB_alloca]], i32 0, i32 [[mask6mod]]
; CHECK: [[srcB6:%[^ ]+]] = load i32, ptr [[srcBGepi6]], align 4
...
; CHECK: [[srcAGepi7:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcA_alloca]], i32 0, i32 [[mask7mod]]
; CHECK: [[srcA7:%[^ ]+]] = load i32, ptr [[srcAGepi7]], align 4
; CHECK: [[srcBGepi7:%[^ ]+]] = getelementptr [8 x i32], ptr [[srcB_alloca]], i32 0, i32 [[mask7mod]]
; CHECK: [[srcB7:%[^ ]+]] = load i32, ptr [[srcBGepi7]], align 4
