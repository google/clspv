...
define spir_kernel void @test(<8 x i32> %src, ptr addrspace(1) noundef align 32 %dst, <8 x i32> %mask) {
entry:
...
; CHECK: [[_srci0:%[^ ]+]] = insertvalue [8 x i32] poison, i32 [[_src0]], 0
...
; CHECK: [[srcGep0:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 0
; CHECK: store i32 [[_srcii0]], ptr [[srcGep0]], align 4
; CHECK: [[_srcii1:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 1
; CHECK: [[srcGep1:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 1
; CHECK: store i32 [[_srcii1]], ptr [[srcGep1]], align 4
; CHECK: [[_srcii2:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 2
; CHECK: [[srcGep2:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 2
; CHECK: store i32 [[_srcii2]], ptr [[srcGep2]], align 4
; CHECK: [[_srcii3:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 3
; CHECK: [[srcGep3:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 3
; CHECK: store i32 [[_srcii3]], ptr [[srcGep3]], align 4
; CHECK: [[_srcii4:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 4
; CHECK: [[srcGep4:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 4
; CHECK: store i32 [[_srcii4]], ptr [[srcGep4]], align 4
; CHECK: [[_srcii5:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 5
; CHECK: [[srcGep5:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 5
; CHECK: store i32 [[_srcii5]], ptr [[srcGep5]], align 4
; CHECK: [[_srcii6:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 6
; CHECK: [[srcGep6:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 6
; CHECK: store i32 [[_srcii6]], ptr [[srcGep6]], align 4
; CHECK: [[_srcii7:%[^ ]+]] = extractvalue [8 x i32] [[_srci7]], 7
; CHECK: [[srcGep7:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 7
; CHECK: store i32 [[_srcii7]], ptr [[srcGep7]], align 4

; CHECK: [[mask0:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 0
; CHECK: [[mask0mod:%[^ ]+]] = urem i32 [[mask0]], 8
; CHECK: [[srcGepi0:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask0mod]]
; CHECK: [[src0:%[^ ]+]] = load i32, ptr [[srcGepi0]], align 4
; CHECK: [[res0:%[^ ]+]] = insertvalue [8 x i32] poison, i32 [[src0]], 0

; CHECK: [[mask1:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 1
; CHECK: [[mask1mod:%[^ ]+]] = urem i32 [[mask1]], 8
; CHECK: [[srcGepi1:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask1mod]]
; CHECK: [[src1:%[^ ]+]] = load i32, ptr [[srcGepi1]], align 4
; CHECK: [[res1:%[^ ]+]] = insertvalue [8 x i32] [[res0]], i32 [[src1]], 1

; CHECK: [[mask2:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 2
; CHECK: [[mask2mod:%[^ ]+]] = urem i32 [[mask2]], 8
; CHECK: [[srcGepi2:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask2mod]]
; CHECK: [[src2:%[^ ]+]] = load i32, ptr [[srcGepi2]], align 4
; CHECK: [[res2:%[^ ]+]] = insertvalue [8 x i32] [[res1]], i32 [[src2]], 2

; CHECK: [[mask3:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 3
; CHECK: [[mask3mod:%[^ ]+]] = urem i32 [[mask3]], 8
; CHECK: [[srcGepi3:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask3mod]]
; CHECK: [[src3:%[^ ]+]] = load i32, ptr [[srcGepi3]], align 4
; CHECK: [[res3:%[^ ]+]] = insertvalue [8 x i32] [[res2]], i32 [[src3]], 3

; CHECK: [[mask4:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 4
; CHECK: [[mask4mod:%[^ ]+]] = urem i32 [[mask4]], 8
; CHECK: [[srcGepi4:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask4mod]]
; CHECK: [[src4:%[^ ]+]] = load i32, ptr [[srcGepi4]], align 4
; CHECK: [[res4:%[^ ]+]] = insertvalue [8 x i32] [[res3]], i32 [[src4]], 4

; CHECK: [[mask5:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 5
; CHECK: [[mask5mod:%[^ ]+]] = urem i32 [[mask5]], 8
; CHECK: [[srcGepi5:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask5mod]]
; CHECK: [[src5:%[^ ]+]] = load i32, ptr [[srcGepi5]], align 4
; CHECK: [[res5:%[^ ]+]] = insertvalue [8 x i32] [[res4]], i32 [[src5]], 5

; CHECK: [[mask6:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 6
; CHECK: [[mask6mod:%[^ ]+]] = urem i32 [[mask6]], 8
; CHECK: [[srcGepi6:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask6mod]]
; CHECK: [[src6:%[^ ]+]] = load i32, ptr [[srcGepi6]], align 4
; CHECK: [[res6:%[^ ]+]] = insertvalue [8 x i32] [[res5]], i32 [[src6]], 6

; CHECK: [[mask7:%[^ ]+]] = extractvalue [8 x i32] [[mask]], 7
; CHECK: [[mask7mod:%[^ ]+]] = urem i32 [[mask7]], 8
; CHECK: [[srcGepi7:%[^ ]+]] = getelementptr [8 x i32], ptr [[src_alloca]], i32 0, i32 [[mask7mod]]
; CHECK: [[src7:%[^ ]+]] = load i32, ptr [[srcGepi7]], align 4
