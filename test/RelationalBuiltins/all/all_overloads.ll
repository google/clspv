...
; CHECK: call i1 @_Z8spirv.op.155.Dv2_b(i32 155, <2 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.155.Dv3_b(i32 155, <3 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.155.Dv4_b(i32 155, <4 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.155.Dv2_b(i32 155, <2 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.155.Dv3_b(i32 155, <3 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.155.Dv4_b(i32 155, <4 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.155.Dv2_b(i32 155, <2 x i1> %{{[0-9]+}})
