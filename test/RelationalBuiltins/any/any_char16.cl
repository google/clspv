...
kernel void foo(global int* a, global char16* b) {
  *a = any(*b);
}
...
// CHECK:     [[vec10:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec11:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec12:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec13:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec20:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec21:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec22:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec23:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec30:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec31:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec32:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec33:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec40:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec41:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec42:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
// CHECK:     [[vec43:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[char0]]
