...
// CHECK-DAG: %[[_struct_8]] = OpTypeStruct %[[_runtimearr_v4ushort]]
...
// CHECK:     %[[__original_id_24:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v4ushort]] %[[__original_id_20]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_25:[0-9]+]] = OpLoad %[[v4ushort]] %[[__original_id_24]]
