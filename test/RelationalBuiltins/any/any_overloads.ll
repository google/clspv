...
; CHECK: call i1 @_Z8spirv.op.154.Dv2_b(i32 154, <2 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.154.Dv3_b(i32 154, <3 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.154.Dv4_b(i32 154, <4 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.154.Dv2_b(i32 154, <2 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.154.Dv3_b(i32 154, <3 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.154.Dv4_b(i32 154, <4 x i1> %{{[0-9]+}})
; CHECK: call i1 @_Z8spirv.op.154.Dv2_b(i32 154, <2 x i1> %{{[0-9]+}})
