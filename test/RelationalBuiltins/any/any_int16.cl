...
kernel void foo(global int* a, global int16* b) {
  *a = any(*b);
}
...
// CHECK:     [[vec30:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec31:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec32:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec33:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec40:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec41:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec42:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
// CHECK:     [[vec43:%[a-zA-Z0-9_]+]] = OpSLessThan [[bool]] {{.*}} [[int_0]]
