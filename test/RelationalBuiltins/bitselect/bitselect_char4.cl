...
// CHECK: [[char4_255_255_255_255:%[a-zA-Z0-9_]+]] = OpConstantComposite [[char4]] [[char_255]] [[char_255]] [[char_255]] [[char_255]]
// CHECK: [[ld_a:%[a-zA-Z0-9_]+]] = OpLoad [[char4]]
// CHECK: [[ld_b:%[a-zA-Z0-9_]+]] = OpLoad [[char4]]
// CHECK: [[ld_c:%[a-zA-Z0-9_]+]] = OpLoad [[char4]]
// CHECK: [[xor:%[a-zA-Z0-9_]+]] = OpBitwiseXor [[char4]] [[ld_c]] [[char4_255_255_255_255]]
