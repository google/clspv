...
; CHECK: [[abs:%[a-zA-Z0-9_.]+]] = and <2 x i32> [[cast]], splat (i32 2147483647)
; CHECK: [[lt:%[a-zA-Z0-9_.]+]] = icmp ult <2 x i32> [[abs]], splat (i32 2139095040)
; CHECK: [[ge:%[a-zA-Z0-9_.]+]] = icmp uge <2 x i32> [[abs]], splat (i32 8388608)
