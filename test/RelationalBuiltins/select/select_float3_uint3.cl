...
// CHECK-DAG: %[[_struct_9]] = OpTypeStruct %[[_runtimearr_v3uint]]
...
// CHECK:     %[[__original_id_25:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v3float]] %[[__original_id_20]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_26:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v3uint]] %[[__original_id_21]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_27:[0-9]+]] = OpLoad %[[v3float]] %[[__original_id_24]]
// CHECK:     %[[__original_id_28:[0-9]+]] = OpLoad %[[v3float]] %[[__original_id_25]]
// CHECK:     %[[__original_id_29:[0-9]+]] = OpLoad %[[v3uint]] %[[__original_id_26]]
