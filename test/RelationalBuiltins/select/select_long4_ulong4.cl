...
// CHECK:     %[[__original_id_21:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v4ulong]] %[[__original_id_16]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_22:[0-9]+]] = OpLoad %[[v4ulong]] %[[__original_id_19]]
// CHECK:     %[[__original_id_23:[0-9]+]] = OpLoad %[[v4ulong]] %[[__original_id_20]]
// CHECK:     %[[__original_id_24:[0-9]+]] = OpLoad %[[v4ulong]] %[[__original_id_21]]
