...
; CHECK: call i1 @_Z8spirv.op.157.f(i32 157, float 2.420000e+00)
; CHECK: call <2 x i1> @_Z8spirv.op.157.Dv2_f(i32 157, <2 x float> splat (float 2.420000e+00))
; CHECK: call <3 x i1> @_Z8spirv.op.157.Dv3_f(i32 157, <3 x float> splat (float 2.420000e+00))
; CHECK: call <4 x i1> @_Z8spirv.op.157.Dv4_f(i32 157, <4 x float> splat (float 2.420000e+00))
