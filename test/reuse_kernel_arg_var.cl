...
// CHECK:  OpDecorate [[_27:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CHECK:  OpDecorate [[_27]] Binding 0
// CHECK:  OpDecorate [[_28:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CHECK:  OpDecorate [[_28]] Binding 1
// CHECK:  OpDecorate [[_29:%[0-9a-zA-Z_]+]] DescriptorSet 0
// CHECK:  OpDecorate [[_29]] Binding 2
// CHECK:  OpDecorate [[_30:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CHECK:  OpDecorate [[_30]] Binding 2
// CHECK:  OpDecorate [[_31:%[0-9a-zA-Z_]+]] DescriptorSet 2
// CHECK:  OpDecorate [[_31]] Binding 0
// CHECK:  OpDecorate [[_32:%[0-9a-zA-Z_]+]] DescriptorSet 2
...
// CLUSTER:  OpDecorate [[_29:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CLUSTER:  OpDecorate [[_29]] Binding 0
// CLUSTER:  OpDecorate [[_30:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CLUSTER:  OpDecorate [[_30]] Binding 1
// CLUSTER:  OpDecorate [[_31:%[0-9a-zA-Z_]+]] DescriptorSet 1
// CLUSTER:  OpDecorate [[_31]] Binding 2
// CLUSTER:  OpDecorate [[_32:%[0-9a-zA-Z_]+]] DescriptorSet 2
// CLUSTER:  OpDecorate [[_32]] Binding 0
// CLUSTER:  OpDecorate [[_33:%[0-9a-zA-Z_]+]] DescriptorSet 2
// CLUSTER:  OpDecorate [[_33]] Binding 1
