...
; CHECK: [[y_in0:%[a-zA-Z0-9_.]+]] = insertelement <3 x half> undef, half %y, i32 0
; CHECK: [[y_shuffle:%[a-zA-Z0-9_.]+]] = shufflevector <3 x half> [[y_in0]], <3 x half> undef, <3 x i32> zeroinitializer
