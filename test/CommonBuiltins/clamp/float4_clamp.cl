...
// CHECK-DAG: %[[COMPOSITE_FLOAT_0_ID:[a-zA-Z0-9_]*]] = OpConstantComposite %[[FLOAT_VECTOR_TYPE_ID]] %[[CONSTANT_FLOAT_0_ID]] %[[CONSTANT_FLOAT_0_ID]] %[[CONSTANT_FLOAT_0_ID]] %[[CONSTANT_FLOAT_0_ID]]
