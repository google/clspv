// RUN: clspv %target %s -o %t.spv --use-native-builtins=mix
...
// CHECK-DAG: %[[COMPOSITE_FLOAT_0_5_ID:[a-zA-Z0-9_]*]] = OpConstantComposite %[[FLOAT_VECTOR_TYPE_ID]] %[[CONSTANT_FLOAT_0_5_ID]] %[[CONSTANT_FLOAT_0_5_ID]] %[[CONSTANT_FLOAT_0_5_ID]] %[[CONSTANT_FLOAT_0_5_ID]]
