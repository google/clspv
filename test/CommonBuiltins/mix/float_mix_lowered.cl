...
// CHECK: %[[SUB_ID:[a-zA-Z0-9_]*]] = OpFSub %[[FLOAT_TYPE_ID]] %[[LOADB_ID]] %[[LOADA_ID]]
// CHECK: %[[MUL_ID:[a-zA-Z0-9_]*]] = OpFMul %[[FLOAT_TYPE_ID]] %[[SUB_ID]] %[[CONSTANT_FLOAT_0_5_ID]]
// CHECK: %[[ADD_ID:[a-zA-Z0-9_]*]] = OpFAdd %[[FLOAT_TYPE_ID]] %[[LOADA_ID]] %[[MUL_ID]]
