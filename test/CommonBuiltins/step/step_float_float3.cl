...
// CHECK:     %[[__original_id_22:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v3float]] %[[__original_id_18]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_23:[0-9]+]] = OpLoad %[[float]] %[[__original_id_21]]
// CHECK:     %[[__original_id_24:[0-9]+]] = OpLoad %[[v3float]] %[[__original_id_22]]
// CHECK:     %[[__original_id_25:[0-9]+]] = OpCompositeInsert %[[v3float]] %[[__original_id_23]] %[[__original_id_16]] 0
// CHECK:     %[[__original_id_26:[0-9]+]] = OpVectorShuffle %[[v3float]] %[[__original_id_25]] %[[__original_id_16]] 0 0 0
