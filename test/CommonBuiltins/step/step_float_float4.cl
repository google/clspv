...
// CHECK:     %[[__original_id_22:[0-9]+]] = OpAccessChain %[[_ptr_StorageBuffer_v4float]] %[[__original_id_18]] %[[uint_0]] %[[uint_0]]
// CHECK:     %[[__original_id_23:[0-9]+]] = OpLoad %[[float]] %[[__original_id_21]]
// CHECK:     %[[__original_id_24:[0-9]+]] = OpLoad %[[v4float]] %[[__original_id_22]]
