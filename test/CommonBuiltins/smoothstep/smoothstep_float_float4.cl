...
// CHECK-DAG: %[[_struct_8]] = OpTypeStruct %[[_runtimearr_v4float]]
...
// CHECK:     %[[__original_id_28:[0-9]+]] = OpCompositeInsert %[[v4float]] %[[__original_id_25]] %[[__original_id_16]] 0
// CHECK:     %[[__original_id_29:[0-9]+]] = OpVectorShuffle %[[v4float]] %[[__original_id_28]] %[[__original_id_16]] 0 0 0 0
// CHECK:     %[[__original_id_30:[0-9]+]] = OpCompositeInsert %[[v4float]] %[[__original_id_26]] %[[__original_id_16]] 0
// CHECK:     %[[__original_id_31:[0-9]+]] = OpVectorShuffle %[[v4float]] %[[__original_id_30]] %[[__original_id_16]] 0 0 0 0
// CHECK:     %[[__original_id_32:[0-9]+]] = OpExtInst %[[v4float]] %[[__original_id_1]] SmoothStep %[[__original_id_29]] %[[__original_id_31]] %[[__original_id_27]]
