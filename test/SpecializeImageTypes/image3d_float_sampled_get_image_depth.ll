...
; CHECK: declare spir_func i32 @_Z15get_image_depth{{.*}}([[image:target\(\"spirv.Image\", float, 2, 0, 0, 0, 1, 0, 0, 0\)]]) [[ATTRS:#[0-9]+]]
...
; CHECK: call spir_func i32 @_Z15get_image_depth{{.*}}([[image]] %image)
...
entry:
  ...
  %h = tail call spir_func i32 @_Z15get_image_depth14ocl_image3d_ro(target("spirv.Image", void, 2, 0, 0, 0, 0, 0, 0) %image)
...
declare spir_func i32 @_Z15get_image_depth14ocl_image3d_ro(target("spirv.Image", void, 2, 0, 0, 0, 0, 0, 0)) #1
