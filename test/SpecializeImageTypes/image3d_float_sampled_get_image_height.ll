...
; CHECK: declare spir_func i32 @_Z16get_image_height28[[IMAGE]](ptr addrspace(1)) [[ATTRS:#[0-9]+]]
...
entry:
  ...
  %h = tail call spir_func i32 @_Z16get_image_height14ocl_image3d_ro(ptr addrspace(1) %image)
