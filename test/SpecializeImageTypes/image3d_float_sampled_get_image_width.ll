...
; CHECK: declare spir_func i32 @_Z15get_image_width28[[IMAGE]](ptr addrspace(1)) [[ATTRS:#[0-9]+]]
...
entry:
  ...
  %h = tail call spir_func i32 @_Z15get_image_width14ocl_image3d_ro(ptr addrspace(1) %image)
