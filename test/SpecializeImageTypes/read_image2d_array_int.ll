...
; CHECK: call spir_func <4 x i32> @_Z11read_imagei32[[IMAGE:ocl_image2d_array_ro.int.sampled]]11ocl_samplerDv4_f(ptr addrspace(1) %image
; CHECK: declare spir_func <4 x i32> @_Z11read_imagei32[[IMAGE]]11ocl_samplerDv4_f(ptr addrspace(1), ptr addrspace(2), <4 x float>) [[ATTRS:#[0-9]+]]
