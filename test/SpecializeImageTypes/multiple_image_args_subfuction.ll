...
; CHECK: call spir_func void @foo([[ro]] %ro, [[wo]] %wo
...
entry:
  tail call spir_func void @foo(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %ro, target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 1) %wo, <2 x float> %coord)
  ret void
}

define spir_func void @foo(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %ro, target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 1) %wo, <2 x float> %coord) {
entry:
