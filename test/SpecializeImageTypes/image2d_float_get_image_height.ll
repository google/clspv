...
entry:
  ...
  %h = tail call spir_func i32 @_Z16get_image_height14ocl_image2d_wo(%opencl.image2d_wo_t addrspace(1)* %image)
  ret void
}
...
declare spir_func i32 @_Z16get_image_height14ocl_image2d_wo(%opencl.image2d_wo_t addrspace(1)*) #2
