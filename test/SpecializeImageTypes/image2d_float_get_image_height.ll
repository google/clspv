...
; CHECK-DAG: declare spir_func void @_Z12write_imagef{{.*}}([[image:target\(\"spirv.Image\", float, 1, 0, 0, 0, 2, 0, 1, 0\)]], <2 x i32>, <4 x float>) [[ATTRS1:#[0-9]+]]
...
entry:
  ...
  %h = tail call spir_func i32 @_Z16get_image_height14ocl_image2d_wo(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 1) %image)
  ret void
}
...
declare spir_func i32 @_Z16get_image_height14ocl_image2d_wo(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 1)) #2
