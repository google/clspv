...
entry:
  ...
  %w = tail call spir_func i32 @_Z15get_image_width20ocl_image2d_array_ro(ptr addrspace(1) %image)
...
declare spir_func i32 @_Z15get_image_width20ocl_image2d_array_ro(ptr addrspace(1)) #2
