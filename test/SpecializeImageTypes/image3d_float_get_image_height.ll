...
; CHECK: declare spir_func i32 @_Z16get_image_height20[[IMAGE]](ptr addrspace(1)) [[ATTRS:#[0-9]+]]
...
entry:
  ...
  %h = tail call spir_func i32 @_Z16get_image_height14ocl_image3d_wo(ptr addrspace(1) %image)
  ret void
}

declare spir_func void @_Z12write_imagef14ocl_image3d_woDv4_iDv4_f(ptr addrspace(1), <4 x i32>, <4 x float>) local_unnamed_addr #1

declare spir_func i32 @_Z16get_image_height14ocl_image3d_wo(ptr addrspace(1)) #1
