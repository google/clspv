...
; CHECK: declare spir_func i32 @_Z16get_image_height{{.*}}([[image:target\(\"spirv.Image\", float, 2, 0, 0, 0, 2, 0, 1, 0\)]]) [[ATTRS:#[0-9]+]]
...
entry:
  ...
  %h = tail call spir_func i32 @_Z16get_image_height14ocl_image3d_wo(target("spirv.Image", void, 2, 0, 0, 0, 0, 0, 1) %image)
  ret void
}
...
declare spir_func i32 @_Z16get_image_height14ocl_image3d_wo(target("spirv.Image", void, 2, 0, 0, 0, 0, 0, 1)) #1
