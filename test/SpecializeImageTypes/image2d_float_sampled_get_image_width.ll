...
entry:
  ...
  %w = tail call spir_func i32 @_Z15get_image_width14ocl_image2d_ro(ptr addrspace(1) %image)
...
declare spir_func i32 @_Z15get_image_width14ocl_image2d_ro(ptr addrspace(1)) #2
