...
entry:
  ...
  %h = tail call spir_func i32 @_Z15get_image_width20ocl_image2d_array_wo(%opencl.image2d_array_wo_t addrspace(1)* %image)
  ret void
}
...
declare spir_func i32 @_Z15get_image_width20ocl_image2d_array_wo(%opencl.image2d_array_wo_t addrspace(1)*) #2
