...
entry:
  ...
  call spir_func void @_Z12write_imagef14ocl_image2d_rwDv2_iDv4_f(ptr addrspace(1) %image, <2 x i32> %coord, <4 x float> %ld) #2
  ret void
}

declare spir_func void @_Z12write_imagef14ocl_image2d_rwDv2_iDv4_f(ptr addrspace(1), <2 x i32>, <4 x float>) local_unnamed_addr #1
