...
entry:
  ...
  %1 = tail call i32 @_Z8spirv.op.236.PU3AS1jjj(i32 236, ptr addrspace(1) %a, i32 1, i32 72, i32 11) #2
  %arrayidx1.i123456 = getelementptr i32, ptr addrspace(1) %data, i32 1
  store i32 %0, ptr addrspace(1) %arrayidx1.i123456, align 4
  ret void
}

declare i32 @_Z8spirv.op.236.PU3AS1jjj(i32, ptr addrspace(1), i32, i32, i32) local_unnamed_addr #1
