...
define dso_local spir_kernel void @foo(ptr addrspace(1) nocapture readonly align 4 %data, ptr addrspace(3) nocapture writeonly align 4 %l) !clspv.pod_args_impl !17 {
entry:
  ...
  store i32 %4, ptr addrspace(3) %1, align 4
  ret void
}
