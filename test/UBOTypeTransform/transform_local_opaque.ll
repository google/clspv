...
define dso_local spir_kernel void @foo(ptr addrspace(1) writeonly align 16 %data, ptr addrspace(2) readonly align 16 %c_arg, ptr addrspace(3) readonly align 16 %l_arg) !clspv.pod_args_impl !0 {
entry:
; get args
