// RUN: clspv %target %s -o %t.spv --use-native-builtins=log10
...
// CHECK-DAG: %[[COMPOSITE_CONSTANT_1_OVER_LN10_ID:[a-zA-Z0-9_]*]] = OpConstantComposite %[[FLOAT_VECTOR_TYPE_ID]] %[[CONSTANT_1_OVER_LN10_ID]] %[[CONSTANT_1_OVER_LN10_ID]]
